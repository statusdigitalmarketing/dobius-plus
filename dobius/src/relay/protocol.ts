...
export const RELAY_SENTINEL = `DOBIUS-RELAY v${RELAY_VERSION} READY\n`
...
export type HandshakeMessage =
  | { type: 'dobius-relay-handshake'; version: string }
  | { type: 'dobius-relay-handshake-ok'; version: string }
  | { type: 'dobius-relay-handshake-mismatch'; expected: string; got: string }
...
export function parseHandshakeMessage(payload: Buffer): HandshakeMessage {
  ...
  if (
    t !== 'dobius-relay-handshake' &&
    t !== 'dobius-relay-handshake-ok' &&
    t !== 'dobius-relay-handshake-mismatch'
  ) {
