...
describe('validateGitExecArgs', () => {
  ...
  describe('git clone', () => {
    it('allows only the project setup clone shape', () => {
      expectAllowed(['clone', '--', 'https://github.com/statusdigitalmarketing/dobius-plus.git', 'dobius'])
      expectAllowed(['clone', '--progress', '--', 'git@github.com:statusdigitalmarketing/dobius-plus.git', 'dobius'])
    })

    it.each([
      [['clone', 'https://github.com/statusdigitalmarketing/dobius-plus.git']],
      [['clone', 'https://github.com/statusdigitalmarketing/dobius-plus.git', 'dobius']],
      [['clone', '--depth=1', '--', 'https://github.com/statusdigitalmarketing/dobius-plus.git', 'dobius']],
      [['clone', '--', 'https://github.com/statusdigitalmarketing/dobius-plus.git', '.']],
      [['clone', '--', 'https://github.com/statusdigitalmarketing/dobius-plus.git', '..']],
      [['clone', '--', 'https://github.com/statusdigitalmarketing/dobius-plus.git', 'nested/dobius']],
      [['clone', '--', 'https://github.com/statusdigitalmarketing/dobius-plus.git', 'nested\\dobius']]
