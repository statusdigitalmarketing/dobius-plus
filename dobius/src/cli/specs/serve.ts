...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an Dobius runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      'dobius serve',
      'dobius serve --json',
      'dobius serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'dobius serve --port 6768 --pairing-address 100.64.1.20',
      'dobius serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]
