...
export const LINEAR_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    examples: ['dobius linear search "auth bug"', 'dobius linear search ENG --workspace all --json']
  },
  {
    ...
    examples: ['dobius linear team list --workspace all --json']
  },
  {
    ...
    examples: ['dobius linear team members --team ENG --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['dobius linear team states --team ENG --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'team', 'workspace'],
    examples: ['dobius linear team labels --team ENG --json']
  },
  {
    path: ['linear', 'project', 'list'],
    summary: 'List connected Linear projects',
    usage:
      'dobius linear project list [--query <text>] [--limit <n>] [--workspace <id>|all] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'query', 'limit', 'workspace'],
    examples: [
      'dobius linear project list --query launch --json',
      'dobius linear project list --workspace all --json'
    ]
  },
  {
    path: ['linear', 'list'],
    ...
    examples: ['dobius linear list --filter assigned --limit 10 --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'dobius linear status set ENG-123 --to "In Review"',
      'dobius linear status set --current --to Done --json'
    ]
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['dobius linear assignee set --current --me --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['dobius linear assignee clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dobius linear priority set --current --to high --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dobius linear priority clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dobius linear estimate set --current --to 3 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dobius linear estimate clear ENG-123 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'to', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dobius linear due-date set --current --to 2026-06-30 --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dobius linear due-date clear ENG-123 --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: ['dobius linear label add --current --label Bug --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'label', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dobius linear label remove --current --label Bug --json']
  },
  {
    ...
    allowedFlags: [...GLOBAL_FLAGS, 'current', 'label', 'workspace', 'id'],
    positionalArgs: ['id'],
    examples: ['dobius linear label set ENG-123 --label Bug --json']
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'dobius linear comment add ENG-123 --body "Implementation is ready for review."',
  ...
  },
  {
    ...
    positionalArgs: ['id'],
    examples: [
      'dobius linear attach ENG-123 --url https://example.com/review/123 --title "PR/MR link"',
      'dobius linear attach --current --url https://example.com/review/123 --json'
    ]
  },
  {
    path: ['linear', 'create'],
    ...
    examples: [
      'dobius linear create --title "Investigate flaky login" --team ENG --project "Launch"',
      'dobius linear create --title "Follow-up bug" --parent-current --body-file - --json'
    ],
