...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'dobius orchestration send --to <handle> --subject <text> [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--task-id <id>] [--dispatch-id <id>] [--files-modified <csv>] [--report-path <path>] [--phase <text>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'from',
  ...
  },
  {
    ...
    usage:
      'dobius orchestration check [--terminal <handle>] [--unread | --all] [--types <type,...>] [--inject] [--wait] [--timeout-ms <n>] [--json]\n' +
  ...
  },
  {
    ...
    usage: 'dobius orchestration reply --id <msg_id> --body <text> [--from <handle>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'id', 'body', 'from']
  },
  {
    path: ['orchestration', 'inbox'],
    summary: 'Show messages across (or for) recipients',
    usage: 'dobius orchestration inbox [--limit <n>] [--terminal <handle>] [--full] [--json]',
  ...
  },
  {
    ...
    usage:
      'dobius orchestration task-create --spec <text> [--task-title <text>] [--display-name <text>] [--deps <json_array>] [--parent <task_id>] [--json]',
  ...
  },
  {
    ...
    usage: 'dobius orchestration task-list [--status <status>] [--ready] [--json]',
  ...
  },
  {
    ...
    usage:
      'dobius orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--inject] [--dry-run] [--return-preamble] [--json]',
  ...
  },
  {
    ...
    usage:
      'dobius orchestration dispatch-show --task <task_id> [--preamble] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage: 'dobius orchestration run-stop [--json]',
  ...
  },
  {
    ...
    usage: 'dobius orchestration gate-resolve --id <gate_id> --resolution <text> [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'id', 'resolution']
  },
  {
    path: ['orchestration', 'gate-list'],
    summary: 'List decision gates',
    usage: 'dobius orchestration gate-list [--task <task_id>] [--status <status>] [--json]',
  ...
  },
  {
    ...
    usage: 'dobius orchestration reset [--all | --tasks | --messages] [--json]',
