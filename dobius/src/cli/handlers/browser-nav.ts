...
// round-trip, even when Dobius is healthy. Give browser.wait an explicit timeout
// budget so slow waits do not get mislabeled as "Dobius is not running" by the
