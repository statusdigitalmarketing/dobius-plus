...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Dobius's browser",
    subtitle: "Use Dobius's browser",
    description:
      'Browse your web app without leaving Dobius. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Dobius+ CLI',
    subtitle: 'Enable Dobius+ CLI',
    description:
      'Register the Dobius shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Dobius so you can start agent work without hunting for folders.'
  }
] as const
