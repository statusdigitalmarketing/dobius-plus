...
// target_type narrows to the four shapes Dobius renders meaningfully —
...
// tab so users can see which job failed and where without leaving Dobius.
...
export type GitLabWorkItemDetails = {
   ...
   *  picker) — main-process doesn't know Dobius's Repo.id. */
