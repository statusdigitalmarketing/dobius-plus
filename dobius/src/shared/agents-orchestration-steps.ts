// Per-step copy for the agents-orchestration tile in the Explore Dobius modal.
...
export const AGENTS_STEPS: readonly AgentsStep[] = [
  ...
  },
  {
    ...
    description: 'Enable agents to manage and coordinate Dobius workspaces to execute larger tasks.'
  },
  {
    id: 'usage',
    name: 'Usage',
