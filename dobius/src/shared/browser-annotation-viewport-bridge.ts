...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__dobius_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__dobiusBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-dobius-browser-annotation-overlay';
  const markerSize = 24;
