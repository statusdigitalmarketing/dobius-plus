export const TERMINAL_SESSION_STATE_SAVE_FAILED_CODE = 'DOBIUS_TERMINAL_SESSION_STATE_SAVE_FAILED'

export const TERMINAL_SESSION_STATE_SAVE_FAILED_MESSAGE =
  'Dobius could not save this terminal session because local storage is unavailable.'
