...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  {
    ...
    docsUrl: 'https://www.ondobius.dev/docs/model/worktrees'
  },
  {
    id: 'tile-02',
    kind: 'media',
    ...
    owner: 'terminal',
    docsUrl: 'https://www.ondobius.dev/docs/terminal'
  },
  {
    id: 'tile-03',
    kind: 'media',
    ...
    docsUrl: 'https://www.ondobius.dev/docs/review/linear'
  },
  {
    id: 'tile-04',
    kind: 'media',
    ...
    docsUrl: 'https://www.ondobius.dev/docs/agents/supported'
  },
  {
    id: 'tile-05',
    kind: 'media',
    ...
    docsUrl: 'https://www.ondobius.dev/docs/browser/design-mode'
  },
  {
    id: 'tile-06',
    kind: 'media',
    ...
    caption:
      'Run agents on a remote machine with the same Dobius editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
    posterPath: 'tile-06.poster.jpg',
    recordedAtPath: 'tile-06.recorded-at.json',
    owner: 'ssh-workspaces',
    docsUrl: 'https://www.ondobius.dev/docs/ssh'
  },
  {
    id: 'tile-07',
    kind: 'media',
    ...
    owner: 'editor',
    docsUrl: 'https://www.ondobius.dev/docs/editing/file-explorer'
  },
  {
    id: 'tile-08',
    kind: 'media',
    ...
    owner: 'diff-review',
    docsUrl: 'https://www.ondobius.dev/docs/review/annotate-ai-diff'
  },
  {
    id: 'tile-09',
    kind: 'media',
    title: 'Dobius+ CLI',
    caption: 'Agents can drive Dobius+ too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
    posterPath: 'tile-09.poster.jpg',
    recordedAtPath: 'tile-09.recorded-at.json',
    owner: 'dobius-cli',
    docsUrl: 'https://www.ondobius.dev/docs/cli/overview'
  },
  {
    id: 'tile-10',
    kind: 'media',
    ...
    owner: 'keyboard-ux',
    docsUrl: 'https://www.ondobius.dev/docs/model/quick-open'
  },
  {
    id: 'tile-11',
    kind: 'media',
    ...
    docsUrl: 'https://www.ondobius.dev/docs/agents/usage-tracking'
  },
  {
    id: 'tile-12',
    kind: 'media',
    ...
    owner: 'file-preview',
    docsUrl: 'https://www.ondobius.dev/docs/editing/viewers'
  }
] as const
