...
export const DOBIUS_BROWSER_PARTITION = 'persist:dobius-browser'
...
export const DOBIUS_BROWSER_BLANK_URL = 'data:text/html,'
...
function getDefaultWorkspaceDir(homeDir: string): string {
  ...
  return [trimmedHomeDir, 'dobius', 'workspaces'].join(separator)
}
...
export function getDefaultSettings(homedir: string): GlobalSettings {
  return {
    ...
    terminalShortcutPolicy: 'dobius-first',
