...
export type FeatureTipId = 'voice-dictation' | 'dobius-cli' | 'cmd-j-palette'
...
export const FEATURE_TIPS = [
  ...
  },
  {
    ...
    description:
      'Speak into any focused pane and Dobius+ will transcribe it. Press the dictation shortcut to start and stop.',
    action: 'enable-voice',
