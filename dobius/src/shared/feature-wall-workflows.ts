...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'Dobius splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    title: 'Agents',
    meta: 'Agents · Usage · Dobius+ CLI',
    lede: 'Run several agents at once, track their progress, and let automation drive Dobius+ when it helps.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into Dobius, then split panes to keep servers, tests, logs, and agents running side by side.',
