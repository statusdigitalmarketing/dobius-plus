...
describe('ephemeral VM runtime store', () => {
  ...
  function makeUserDataPath(): string {
    const userDataPath = mkdtempSync(join(tmpdir(), 'dobius-ephemeral-vm-store-'))
  ...
  it('updates lifecycle and cleanup state', () => {
    ...
    const failed = updateEphemeralVmRuntimeStatus(userDataPath, 'dobius-instance-1', {
    ...
    const recovered = updateEphemeralVmRuntimeStatus(userDataPath, 'dobius-instance-1', {
      status: 'cleaned',
