...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote dobius runtime|remote dobius runtime closed the connection|timed out (?:waiting for|while connecting to) the remote dobius runtime/i
