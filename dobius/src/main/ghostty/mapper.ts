...
export function mapGhosttyToDobius(
  ...
  const FIELD_PARSERS: Record<string, FieldParser> = {
    ...
    'focus-follows-mouse': (v) => {
      // Why: Ghostty's focus-follows-mouse is semantically identical to Dobius's
  ...
  for (const [key, rawValue] of Object.entries(parsed)) {
    ...
    // Why: Dobius's windowBackgroundBlur is a boolean; the numeric radius is lost.
