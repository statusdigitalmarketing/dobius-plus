...
function getLegacyTokenPath(): string {
  return join(getDobiusDir(), 'linear-token.enc')
}

function getLegacyViewerPath(): string {
  return join(getDobiusDir(), 'linear-viewer.json')
}

function getWorkspaceFilePath(): string {
  return join(getDobiusDir(), 'linear-workspaces.json')
}

function getWorkspaceTokenDir(): string {
  return join(getDobiusDir(), 'linear-tokens')
}
