...
const DOBIUS_PROJECT_DETAIL_FIELDS = `
  ${DOBIUS_PROJECT_FIELDS}
...
const PROJECTS_QUERY = `
  query DobiusLinearProjects($first: Int, $filter: ProjectFilter, $orderBy: PaginationOrderBy) {
...
const SEARCH_PROJECTS_QUERY = `
  query DobiusLinearProjectSearch($term: String!, $first: Int, $after: String) {
...
const PROJECT_QUERY = `
  query DobiusLinearProject($id: String!) {
    project(id: $id) {
      ${DOBIUS_PROJECT_DETAIL_FIELDS}
    }
  }
`

const CREATE_PROJECT_MUTATION = `
  mutation DobiusLinearProjectCreate($input: ProjectCreateInput!) {
...
const PROJECT_ISSUES_QUERY = `
  query DobiusLinearProjectIssues(
    $id: String!,
    $first: Int,
    $after: String,
...
const PROJECT_TEAMS_QUERY = `
  query DobiusLinearProjectTeams($id: String!, $first: Int, $after: String) {
    project(id: $id) {
...
const CUSTOM_VIEW_QUERY = `
  query DobiusLinearCustomView($id: String!) {
    customView(id: $id) {
      id
      name
      description
...
const CUSTOM_VIEW_ISSUES_QUERY = `
  query DobiusLinearCustomViewIssues(
    $id: String!,
    $first: Int,
    $after: String,
    $orderBy: PaginationOrderBy
...
const CUSTOM_VIEW_PROJECTS_QUERY = `
  query DobiusLinearCustomViewProjects($id: String!, $first: Int, $orderBy: PaginationOrderBy) {
    customView(id: $id) {
      id
      modelName
...
async function readIssueConnectionPages(
  ...
  while (items.length < limit) {
    ...
    // Dobius reads must follow cursors to show more than one backend page.
