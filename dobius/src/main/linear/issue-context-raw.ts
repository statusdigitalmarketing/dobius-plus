...
export const ISSUE_QUERY = `
  query DobiusAgentLinearIssue($id: String!) {
    issue(id: $id) {
      ${ISSUE_FIELDS}
    }
  }
...
export const SEARCH_QUERY = `
  query DobiusAgentLinearSearch($term: String!, $first: Int) {
...
export const COMMENTS_QUERY = `
  query DobiusAgentLinearIssueComments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const CHILDREN_QUERY = `
  query DobiusAgentLinearIssueChildren($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const ATTACHMENTS_QUERY = `
  query DobiusAgentLinearIssueAttachments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const RELATIONS_QUERY = `
  query DobiusAgentLinearIssueRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
