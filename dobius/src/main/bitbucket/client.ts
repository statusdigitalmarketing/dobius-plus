...
function getAuthConfig(): BitbucketAuthConfig {
  return {
    baseUrl: readProviderEnv('BITBUCKET_API_BASE_URL') ?? DEFAULT_API_BASE_URL,
    accessToken: readProviderEnv('BITBUCKET_ACCESS_TOKEN'),
    email: readProviderEnv('BITBUCKET_EMAIL'),
    apiToken: readProviderEnv('BITBUCKET_API_TOKEN')
  }
}
