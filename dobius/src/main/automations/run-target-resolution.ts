...
export function resolveAutomationRunTarget(
  ...
  if (
    ...
    return {
      ok: false,
      error:
        'Remote-server automation scheduling is not available from this Dobius client yet. Run this automation on the remote server or update Dobius when durable remote scheduling is available.'
    }
  }
