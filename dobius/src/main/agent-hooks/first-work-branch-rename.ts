...
export type FirstWorkBranchRenameDeps = {
  ...
  /** True only for Dobius-created worktrees whose branch Dobius is allowed to rename. */
  canRenameDobiusCreatedBranch: (worktreeId: string) => boolean
...
async function runAutoRename(
  ...
  // Only rename a branch Dobius auto-named — never one the user chose.
