...
beforeEach(() => {
  ...
  fakeHomeDir = mkdtempSync(join(tmpdir(), 'dobius-codex-usage-home-'))
  userDataDir = mkdtempSync(join(tmpdir(), 'dobius-codex-usage-user-data-'))
...
describe('getCodexSessionsDirectory', () => {
  it('defaults to Dobius-managed Codex runtime sessions', () => {
...
describe('listCodexSessionFiles', () => {
  it('scans both Dobius-managed and system Codex session homes', async () => {
