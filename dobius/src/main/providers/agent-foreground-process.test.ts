      ...
      (_cmd: string, _args: string[], _opts: unknown, cb: unknown) => {
        ...
        callback(null, {
          stdout: [
            ...
            'ProcessId=100',
            '',
            'CommandLine=node C:\\Users\\dev\\AppData\\Roaming\\npm\\node_modules\\@openai\\codex\\bin\\codex.js --cwd C:\\repo\\dobius',
      ...
      (_cmd: string, _args: string[], _opts: unknown, cb: unknown) => {
        ...
        callback(null, {
          stdout: [
            ...
            'ProcessId=100',
            '',
            'CommandLine=codex --cwd C:\\repo\\dobius',
            'CreationDate=20260616110100.000000-000',
            ...
            'ProcessId=101',
            '',
            'CommandLine=gemini --cwd C:\\repo\\dobius',
            'CreationDate=20260616110200.000000-000',
            'ExecutablePath=C:\\Users\\dev\\AppData\\Roaming\\npm\\gemini.cmd',
            'Name=gemini.exe',
            'ParentProcessId=101',
