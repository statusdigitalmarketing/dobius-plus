...
export class SshPtyProvider implements IPtyProvider {
  ...
  private withRemoteCliBridgeEnv(
    ...
    merged.DOBIUS_REMOTE_CLI_BIN_DIR = this.remoteCliBridgeEnv.binDir
    merged.DOBIUS_RELAY_DIR = this.remoteCliBridgeEnv.relayDir
    merged.DOBIUS_RELAY_NODE_PATH = this.remoteCliBridgeEnv.nodePath
    merged.DOBIUS_RELAY_SOCKET_PATH = this.remoteCliBridgeEnv.sockPath
    return merged
  }
