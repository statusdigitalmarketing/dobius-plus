...
describe('SshPtyProvider', () => {
  ...
  describe('spawn', () => {
    ...
    it('injects the relay-backed Dobius CLI bridge into remote PTY env', async () => {
      mux.request.mockResolvedValue({ id: 'pty-bridge' })
      provider = new SshPtyProvider('conn-1', mux as never, {
        binDir: '/home/user/.dobius-relay/bin',
        relayDir: '/home/user/.dobius-relay/relay-v1',
        nodePath: '/usr/bin/node',
        sockPath: '/home/user/.dobius-relay/relay.sock'
      })

      await provider.spawn({
        cols: 120,
        rows: 40,
        env: { PATH: '/usr/bin', DOBIUS_TERMINAL_HANDLE: 'term_ssh' }
      })
      ...
      expect(mux.request).toHaveBeenCalledWith('pty.spawn', {
        ...
        cwd: undefined,
        env: {
          PATH: '/home/user/.dobius-relay/bin:/usr/bin',
          DOBIUS_TERMINAL_HANDLE: 'term_ssh',
          [POWERLEVEL10K_WIZARD_DISABLE_ENV]: 'true',
          DOBIUS_REMOTE_CLI_BIN_DIR: '/home/user/.dobius-relay/bin',
          DOBIUS_RELAY_DIR: '/home/user/.dobius-relay/relay-v1',
          DOBIUS_RELAY_NODE_PATH: '/usr/bin/node',
          DOBIUS_RELAY_SOCKET_PATH: '/home/user/.dobius-relay/relay.sock'
        }
      })
    })
    ...
    it('does not clobber the remote relay PATH when caller env has no PATH', async () => {
      ...
      await provider.spawn({
        cols: 120,
        rows: 40,
        env: { DOBIUS_TERMINAL_HANDLE: 'term_ssh' }
      })
    ...
    it('uses Windows PATH delimiters for native Windows SSH bridge env', async () => {
      mux.request.mockResolvedValue({ id: 'pty-bridge' })
      provider = new SshPtyProvider('conn-1', mux as never, {
        binDir: 'C:/Users/me/.dobius-relay/bin',
        relayDir: 'C:/Users/me/.dobius-remote/relay-v1',
        nodePath: 'C:/Program Files/nodejs/node.exe',
        sockPath: '\\\\.\\pipe\\dobius-relay-123',
        pathDelimiter: ';'
      })
      ...
      expect(mux.request).toHaveBeenCalledWith('pty.spawn', {
        ...
        cwd: undefined,
        env: {
          Path: 'C:/Users/me/.dobius-relay/bin;C:/Windows/System32;C:/Tools',
          [POWERLEVEL10K_WIZARD_DISABLE_ENV]: 'true',
          DOBIUS_REMOTE_CLI_BIN_DIR: 'C:/Users/me/.dobius-relay/bin',
          DOBIUS_RELAY_DIR: 'C:/Users/me/.dobius-remote/relay-v1',
          DOBIUS_RELAY_NODE_PATH: 'C:/Program Files/nodejs/node.exe',
          DOBIUS_RELAY_SOCKET_PATH: '\\\\.\\pipe\\dobius-relay-123'
        }
      })
    })
