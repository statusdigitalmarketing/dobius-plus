...
vi.mock('./updater-prerelease-feed', () => ({
  ...
  getReleaseDownloadUrl: (tag: string) =>
    `https://github.com/statusdigitalmarketing/dobius-plus/releases/download/${tag}`
}))
...
describe('updater', () => {
  ...
  it('runs a fresh prerelease check when Shift-click promotes an in-flight stable check', async () => {
    ...
    expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
      provider: 'generic',
      url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.4.36-rc.5'
    })
    expect(
      sendMock.mock.calls
        .filter(([channel]) => channel === 'updater:status')
  ...
  it('opts into the RC channel when checkForUpdatesFromMenu is called with includePrerelease', async () => {
    ...
    await vi.waitFor(() => {
      ...
      expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
        provider: 'generic',
        url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.3.18-rc.1'
      })
      expect(autoUpdaterMock.checkForUpdates).toHaveBeenCalledTimes(1)
    })
  ...
  it('pins the generic feed to a perf-tagged prerelease when requested', async () => {
    ...
    await vi.waitFor(() => {
      ...
      expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
        provider: 'generic',
        url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.4.121-rc.6.perf'
      })
      expect(autoUpdaterMock.checkForUpdates).toHaveBeenCalledTimes(1)
    })
    expect(autoUpdaterMock.allowPrerelease).toBe(true)
  ...
  it('keeps background retries on the stable channel after a perf publishing-window miss', async () => {
    ...
    await vi.waitFor(() => {
      ...
      expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
        provider: 'generic',
        url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.4.121'
      })
    })
  })
  ...
  it('repins the generic feed to the newest RC tag for a prerelease user', async () => {
    ...
    expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
      provider: 'generic',
      url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/latest/download'
    })
    expect(autoUpdaterMock.allowPrerelease).not.toBe(true)
    ...
    await vi.waitFor(() => {
      ...
      expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
        provider: 'generic',
        url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.3.17-rc.2'
      })
      expect(autoUpdaterMock.checkForUpdates).toHaveBeenCalledTimes(1)
    })
  })
  ...
  it('repins the generic feed to a newer stable tag for a prerelease user', async () => {
    ...
    await vi.waitFor(() => {
      expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
        provider: 'generic',
        url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.3.19'
      })
    })
    expect(autoUpdaterMock.allowPrerelease).not.toBe(true)
  })
  ...
  it('uses last-good concrete feed when a user-initiated check lands during publishing', async () => {
    ...
    expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
      provider: 'generic',
      url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.4.26'
    })
    expect(autoUpdaterMock.setFeedURL).not.toHaveBeenCalledWith({
      provider: 'generic',
      url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.4.27'
    })
  ...
  it('retries a prerelease check once against the previous feed tag when the manifest is missing', async () => {
    ...
    await vi.waitFor(() => {
      ...
      expect(autoUpdaterMock.setFeedURL).toHaveBeenCalledWith({
        provider: 'generic',
        url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.3.51-rc.7'
      })
      expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
        provider: 'generic',
        url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.3.51-rc.6'
      })
    })
  ...
  it('pins the generic feed to a concrete stable tag for a stable user', async () => {
    ...
    expect(autoUpdaterMock.setFeedURL).toHaveBeenLastCalledWith({
      provider: 'generic',
      url: 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.3.18'
    })
  })
