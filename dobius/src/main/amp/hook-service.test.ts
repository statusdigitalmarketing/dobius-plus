...
describe('AmpHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'dobius-amp-home-'))
  ...
  it('installs an Dobius-managed Amp system plugin', () => {
    ...
    expect(source).toContain('process.env.DOBIUS_PANE_KEY')
  ...
  it('removes only Dobius-managed Amp plugin files', () => {
