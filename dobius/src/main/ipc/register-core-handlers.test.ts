...
const {
  ...
  registerImessageBridgeHandlersMock,
  ...
  registerAgentsHandlersMock,
  registerExportHandlersMock,
  registerKnowledgeHandlersMock,
  ...
  registerImessageBridgeHandlersMock: vi.fn(),
  ...
  registerAgentsHandlersMock: vi.fn(),
  registerExportHandlersMock: vi.fn(),
  registerKnowledgeHandlersMock: vi.fn(),
...
vi.mock('./imessage-bridge', () => ({
  registerImessageBridgeHandlers: registerImessageBridgeHandlersMock
}))
...
vi.mock('./agents', () => ({
  registerAgentsHandlers: registerAgentsHandlersMock
}))

vi.mock('./knowledge', () => ({
  registerKnowledgeHandlers: registerKnowledgeHandlersMock
}))
...
vi.mock('../agents/agent-dispatch-registry', () => ({
  setBuildDispatcher: setBuildDispatcherMock,
  setRepoLister: setRepoListerMock
}))
...
describe('registerCoreHandlers', () => {
  beforeEach(() => {
    ...
    registerImessageBridgeHandlersMock.mockReset()
    ...
    registerAgentsHandlersMock.mockReset()
    registerExportHandlersMock.mockReset()
    registerKnowledgeHandlersMock.mockReset()
  ...
  it('passes the store through to handler registrars that need it', () => {
    ...
    expect(registerAgentsHandlersMock).toHaveBeenCalled()
    expect(registerFeedbackHandlersMock).toHaveBeenCalled()
    expect(registerImessageBridgeHandlersMock).toHaveBeenCalled()
    ...
    expect(registerKnowledgeHandlersMock).toHaveBeenCalledWith(store)
    ...
    expect(setRepoListerMock).toHaveBeenCalledWith(expect.any(Function))
    expect(setBuildDispatcherMock).toHaveBeenCalledWith(expect.any(Function))
  })
