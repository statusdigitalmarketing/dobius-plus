  ...
  it.each([
    ...
    async (platform, manifestName) => {
      ...
      expect(manifestUrls).toEqual([
        `https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.4.1/${manifestName}`
      ])
      expect(assetUrls).toEqual([
        'https://github.com/statusdigitalmarketing/dobius-plus/releases/download/v1.4.1/Dobius-1.4.1-arm64-mac.zip'
      ])
    }
  )
