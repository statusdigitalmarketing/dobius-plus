...
const pidFile = process.env.DOBIUS_DEV_WRAPPER_TEST_PID_FILE
const envFile = process.env.DOBIUS_DEV_WRAPPER_TEST_ENV_FILE
...
if (!pidFile) {
  throw new Error('DOBIUS_DEV_WRAPPER_TEST_PID_FILE is required')
}
    ...
    JSON.stringify(
      {
        ...
        label: process.env.DOBIUS_DEV_INSTANCE_LABEL ?? null,
        branch: process.env.DOBIUS_DEV_BRANCH ?? null,
        worktreeName: process.env.DOBIUS_DEV_WORKTREE_NAME ?? null,
        repoRoot: process.env.DOBIUS_DEV_REPO_ROOT ?? null,
        badgeLabel: process.env.DOBIUS_DEV_DOCK_BADGE_LABEL ?? null,
        dockTitle: process.env.DOBIUS_DEV_DOCK_TITLE ?? null,
        stableName: process.env.DOBIUS_DEV_STABLE_NAME ?? null,
