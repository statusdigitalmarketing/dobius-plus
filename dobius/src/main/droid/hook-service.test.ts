...
describe('DroidHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'dobius-droid-home-'))
    userDataDir = mkdtempSync(join(tmpdir(), 'dobius-droid-user-data-'))
  ...
  it.skipIf(process.platform !== 'win32')(
    ...
    () => {
      const spaceHome = join(tmpdir(), 'dobius droid home with spaces')
