/* eslint-disable max-lines -- Why: this file is a command adapter for one external surface, Agent Browser automation. It stays separate from DobiusRuntimeService so runtime state does not grow further while browser routing remains easy to scan in one place. */
...
export class RuntimeBrowserCommands {
  ...
  // listeners never fire, leaving the Zustand store (and thus the Dobius UI's
