...
// Why: dedicated file for "one surface" separation (emulator), parallel to dobius-runtime-browser.ts. Keeps DobiusRuntimeService focused; emulator routing easy to scan. No max-lines disable (split further if grows; per AGENTS + plan Phase 3).
...
export class RuntimeEmulatorCommands {
  ...
  // devices/AVDs) for the cross-platform `dobius emulator devices` command.
