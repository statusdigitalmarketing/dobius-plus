...
export class RuntimeFileCommands {
  ...
  async openMobileFile(
    ...
    // (those live in dobius-environments.json). Passing it caused Unknown environment
    // errors on content load for CLI-initiated opens (via files.open from dobius cli
