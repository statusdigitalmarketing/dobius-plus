...
const ATOM_FEED_URL = 'https://github.com/statusdigitalmarketing/dobius-plus/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/statusdigitalmarketing/dobius-plus/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/statusdigitalmarketing\/dobius-plus\/releases\/tag\/([^"]+)"/g
