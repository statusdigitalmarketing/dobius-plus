...
const DOBIUS_CLAUDE_SERVICE = 'Dobius Claude Code Managed Credentials'
...
export async function readManagedClaudeKeychainCredentials(
  ...
  return readKeychainPassword(DOBIUS_CLAUDE_SERVICE, accountId)
}
...
export async function writeManagedClaudeKeychainCredentials(
  ...
  await writeKeychainPassword(DOBIUS_CLAUDE_SERVICE, accountId, contents)
}

export async function deleteManagedClaudeKeychainCredentials(accountId: string): Promise<void> {
  await deleteKeychainPassword(DOBIUS_CLAUDE_SERVICE, accountId)
}
