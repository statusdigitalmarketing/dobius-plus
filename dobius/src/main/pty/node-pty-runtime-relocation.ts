 ...
 * Loading them from userData (via the DOBIUS_NODE_PTY_NATIVE_DIR override
 ...
 */
export const NODE_PTY_NATIVE_DIR_ENV_VAR = 'DOBIUS_NODE_PTY_NATIVE_DIR'
...
export function installRelocatedNodePtyNativeRuntime(): void {
  ...
  if (!app.isPackaged && process.env.DOBIUS_FORCE_CONPTY_RELOCATION !== '1') {
    return
  }
