...
// the error-tracking lane to Dobius infrastructure. Every step here implements
...
export type CollectBundleOptions = {
  ...
  readonly dobiusChannel: 'stable' | 'rc' | 'dev'
}
...
type BundleHeader = {
  ...
  readonly dobius_channel: 'stable' | 'rc' | 'dev'
...
export function collectBundle(opts: CollectBundleOptions): CollectedBundle {
  ...
  const header: BundleHeader = {
    ...
    dobius_channel: opts.dobiusChannel,
