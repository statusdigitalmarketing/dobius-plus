...
describe('registerClipboardHandlers', () => {
  ...
  it('sweeps expired remote clipboard staging directories', async () => {
    ...
    fsReaddirMock.mockResolvedValue([
      dirent('dobius-clipboard-file-expired'),
      dirent('dobius-clipboard-file-fresh'),
      dirent('dobius-clipboard-file-plain-file', false),
    ...
    expect(fsRmMock).toHaveBeenCalledWith(join('/tmp', 'dobius-clipboard-file-expired'), {
      recursive: true,
      force: true
    })
  })
  ...
  it('materializes remote files before writing them to the OS clipboard', async () => {
    ...
    const tempDir = join(
      '/tmp',
      'dobius-clipboard-file-1760000000000-00000000-0000-4000-8000-000000000000'
    )
  ...
  it('saves clipboard images to a local temp file when no connection is provided', async () => {
    ...
    const expectedPath = join(
      '/tmp',
      'dobius-paste-1760000000000-00000000-0000-4000-8000-000000000000.png'
    )
  ...
  it('saves clipboard images through the selected remote runtime host', async () => {
    ...
    callRuntimeEnvironmentMock.mockImplementation(async (_userDataPath, _runtimeId, method) => {
      ...
      if (method === 'clipboard.commitImageUpload') {
        return {
          ok: true,
          result: '/tmp/dobius-paste-remote.png',
          _meta: { runtimeId: 'runtime-1' }
        }
      }
    ...
    ).resolves.toBe('/tmp/dobius-paste-remote.png')
  ...
  it('uploads clipboard images to the SSH host when a connection is provided', async () => {
    ...
    ).resolves.toBe('/var/tmp/dobius-paste-1760000000000-00000000-0000-4000-8000-000000000000.png')
    ...
    expect(writeFileBase64).toHaveBeenCalledWith(
      '/var/tmp/dobius-paste-1760000000000-00000000-0000-4000-8000-000000000000.png',
      png.toString('base64')
    )
    expect(fsWriteFileMock).not.toHaveBeenCalled()
  })
  ...
  it('uses Windows path joining for Windows SSH temp directories', async () => {
    ...
    await expect(
      ...
      'C:\\Users\\alice\\AppData\\Local\\Temp\\dobius-paste-1760000000000-00000000-0000-4000-8000-000000000000.png'
    )
    expect(writeFileBase64).toHaveBeenCalledWith(
      'C:\\Users\\alice\\AppData\\Local\\Temp\\dobius-paste-1760000000000-00000000-0000-4000-8000-000000000000.png',
      png.toString('base64')
