...
describe('scanRemoteAiVaultSessions', () => {
  it('parses remote default and Dobius-managed Codex homes with SSH host ids', async () => {
    ...
    provider.addFile(
      '/home/ada/.local/share/dobius/codex-runtime-home/home/sessions/runtime.jsonl',
      jsonLines([
        {
    ...
    expect(
      ...
      codexHome: '/home/ada/.local/share/dobius/codex-runtime-home/home',
      resumeCommand:
        "cd '/home/ada/runtime-repo' && CODEX_HOME='/home/ada/.local/share/dobius/codex-runtime-home/home' codex resume 'runtime-session'"
    })
  })
