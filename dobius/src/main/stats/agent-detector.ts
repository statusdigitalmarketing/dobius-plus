 ...
 * dobius-runtime.ts normalizeTerminalChunk but avoids importing the runtime.
 */
...
export class AgentDetector {
  ...
  /**
   * Called on every PTY data chunk (from dobius-runtime.ts onPtyData).
  ...
  /**
   * Called when a PTY process exits (from dobius-runtime.ts onPtyExit).
   */
