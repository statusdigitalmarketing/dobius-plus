...
describe('createEditorSlice floating editor activation', () => {
  ...
  it('opens floating markdown tabs without changing the main active editor surface', () => {
    ...
    store.getState().openFile({
      filePath: '/tmp/dobius/untitled.md',
...
describe('createEditorSlice activateMarkdownLink', () => {
  ...
  it('can open a local file without adopting the currently active runtime owner', () => {
    ...
    store.getState().openFile(
      {
        filePath: '/remote/.dobius/drops/log.txt',
        relativePath: '.dobius/drops/log.txt',
        worktreeId: 'wt-1',
        language: 'text',
        mode: 'edit'
      },
  ...
  it('opens in-worktree file links in Dobius', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs inside the worktree in Dobius', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs outside the worktree in Dobius after authorizing them', async () => {
    const store = createEditorStore()
