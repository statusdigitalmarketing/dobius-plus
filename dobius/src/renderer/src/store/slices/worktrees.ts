  ...
  toast.warning(
    ...
    }),
    {
      description: translate(
        ...
        'Workspace created from {{value0}}, but Dobius+ could not fast-forward local {{value1}} because {{value2}}',
  ...
  toast.error(
    ...
    ),
    {
      ...
      description: translate(
        ...
        'Workspaces are unavailable on a mobile-scope pairing. Reconnect using the browser access link from Settings → Runtime Environments → Share this Dobius+ server.'
      )
    }
  )
  return true
