  ...
  switch (status.reason) {
    case 'missing':
      return translate(
        ...
        'Dobius+ cannot find {{path}}. Remove and re-import this folder workspace.',
        { path: status.path }
      )
    case 'not-directory':
      return translate(
    ...
    case 'ambiguous-connection':
      return translate(
        ...
        'Dobius+ cannot tell which SSH connection owns this folder scope.'
      )
    case undefined:
    case 'unavailable':
      return translate(
        'auto.lib.folderWorkspacePathStatus.description.unavailable',
        'Dobius+ cannot verify this folder right now. Check the runtime or SSH connection and try again.'
      )
  }
}
  ...
  if (message.startsWith('folder_workspace_path_missing:')) {
    return {
      ...
      description: translate(
        ...
        'Dobius+ cannot find {{path}}. Remove and re-import the folder.',
        { path }
      )
    }
  }
