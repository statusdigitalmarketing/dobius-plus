...
import { activateDobiusTerminalUnicodeProvider } from '../../../../shared/terminal-unicode-provider'
...
export function openTerminal(pane: ManagedPaneInternal): void {
  ...
  // Activate Dobius+'s Unicode 11 width shim *before* any caller-driven write. CJK / emoji /
  ...
  activateDobiusTerminalUnicodeProvider(terminal)
