...
export const APP_MENU_PASTE_EVENT = 'dobius-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Dobius+ already resolved.
  ...
  // Why: for text controls Dobius+ has already resolved ownership. Falling back
