...
export const AI_VAULT_SESSION_DRAG_TYPE = 'application/x-dobius-ai-vault-session'
export const AI_VAULT_SESSION_DRAG_START_EVENT = 'dobius-ai-vault-session-drag-start'
export const AI_VAULT_SESSION_DRAG_END_EVENT = 'dobius-ai-vault-session-drag-end'
...
export function writeAiVaultSessionDragData(
  ...
  // resume command instead of letting Dobius+'s pane drop layer handle it.
