...
// Regression guard for crash report e08749bb-777c-446e-b407-5d1f154b6173 (Dobius 1.4.104).
...
// once this session (sessionStorage 'dobius:lazy-chunk-reload-attempted' === '1'),
...
const RELOAD_GUARD_KEY = 'dobius:lazy-chunk-reload-attempted'
