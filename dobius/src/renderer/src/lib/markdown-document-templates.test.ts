...
describe('markdown document templates', () => {
  ...
  it('discovers markdown files under .dobius/templates and skips unsafe entries', async () => {
    const readDir = stubReadDir({
      '/repo/.dobius/templates': [
        entry('daily-note.md'),
        entry('scratch.txt'),
      ...
      '/repo/.dobius/templates/nested': [entry('meeting.markdown'), entry('brief.mdx')]
    })
    ...
    await expect(
      ...
      {
        id: '.dobius/templates/nested/brief.mdx',
        name: 'Brief',
        filePath: '/repo/.dobius/templates/nested/brief.mdx',
        relativePath: '.dobius/templates/nested/brief.mdx',
        templateRelativePath: 'nested/brief.mdx',
        basename: 'brief.mdx'
      },
      {
        id: '.dobius/templates/daily-note.md',
        name: 'Daily note',
        filePath: '/repo/.dobius/templates/daily-note.md',
        relativePath: '.dobius/templates/daily-note.md',
        templateRelativePath: 'daily-note.md',
        basename: 'daily-note.md'
      },
      {
        id: '.dobius/templates/nested/meeting.markdown',
        name: 'Meeting',
        filePath: '/repo/.dobius/templates/nested/meeting.markdown',
        relativePath: '.dobius/templates/nested/meeting.markdown',
  ...
  it('keeps Windows file paths native while exposing root-relative template paths', async () => {
    stubReadDir({
      'C:\\repo\\.dobius\\templates': [entry('daily.md')]
    })
    ...
    await expect(
      ...
      {
        id: '.dobius/templates/daily.md',
        name: 'Daily',
        filePath: 'C:\\repo\\.dobius\\templates\\daily.md',
        relativePath: '.dobius/templates/daily.md',
