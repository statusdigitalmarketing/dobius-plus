...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'dobius:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'dobius:emulator-launch-failed'
