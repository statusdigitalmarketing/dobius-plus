...
describe('isWorkItemLookupText', () => {
  it('detects GitHub PR and issue URLs', () => {
    expect(isWorkItemLookupText('https://github.com/statusdigitalmarketing/dobius-plus/pull/4900')).toBe(true)
    expect(isWorkItemLookupText('https://github.com/statusdigitalmarketing/dobius-plus/issues/123')).toBe(true)
    expect(isWorkItemLookupText('  https://www.github.com/statusdigitalmarketing/dobius-plus/pull/1 ')).toBe(true)
  })
