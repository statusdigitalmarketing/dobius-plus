...
describe('parseGitLabIssueOrMRNumber', () => {
  ...
  it('parses gitlab.com issue and MR URLs', () => {
    expect(parseGitLabIssueOrMRNumber('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/issues/923')).toBe(923)
    expect(
      parseGitLabIssueOrMRNumber('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/merge_requests/123')
    ).toBe(123)
  })
  ...
  it('parses modern /-/work_items/<iid> issue URLs', () => {
    expect(parseGitLabIssueOrMRNumber('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/work_items/923')).toBe(
      923
    )
    expect(
  ...
  it('rejects GitHub URLs (no /-/ separator)', () => {
    expect(parseGitLabIssueOrMRNumber('https://github.com/statusdigitalmarketing/dobius-plus/issues/923')).toBeNull()
    expect(parseGitLabIssueOrMRNumber('https://github.com/statusdigitalmarketing/dobius-plus/pull/123')).toBeNull()
  })
...
describe('parseGitLabIssueOrMRLink', () => {
  it('extracts slug + number + type for issues and MRs', () => {
    expect(parseGitLabIssueOrMRLink('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/issues/923')).toEqual({
      slug: { host: 'gitlab.com', path: 'statusdigitalmarketing/dobius-plus' },
      number: 923,
      type: 'issue'
    })
    expect(
      parseGitLabIssueOrMRLink('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/merge_requests/77')
    ).toEqual({ slug: { host: 'gitlab.com', path: 'statusdigitalmarketing/dobius-plus' }, number: 77, type: 'mr' })
  })
  ...
  it('treats /-/work_items/<iid> as an issue work item', () => {
    expect(parseGitLabIssueOrMRLink('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/work_items/923')).toEqual({
      slug: { host: 'gitlab.com', path: 'statusdigitalmarketing/dobius-plus' },
      number: 923,
      type: 'issue'
    })
  ...
  it('returns null for non-GitLab URL shapes', () => {
    expect(parseGitLabIssueOrMRLink('https://gitlab.com/statusdigitalmarketing/dobius-plus/issues/123')).toBeNull()
    expect(parseGitLabIssueOrMRLink('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/issues/123abc')).toBeNull()
  })
})
...
describe('normalizeGitLabLinkQuery', () => {
  ...
  it('routes a full URL to query + directNumber', () => {
    expect(normalizeGitLabLinkQuery('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/issues/923')).toEqual({
      query: 'https://gitlab.com/statusdigitalmarketing/dobius-plus/-/issues/923',
      directNumber: 923
    })
  })
  ...
  it('routes full URLs with trailing page segments to directNumber', () => {
    expect(
      normalizeGitLabLinkQuery('https://gitlab.com/statusdigitalmarketing/dobius-plus/-/merge_requests/77/diffs')
    ).toEqual({
      query: 'https://gitlab.com/statusdigitalmarketing/dobius-plus/-/merge_requests/77/diffs',
      directNumber: 77
    })
  })
