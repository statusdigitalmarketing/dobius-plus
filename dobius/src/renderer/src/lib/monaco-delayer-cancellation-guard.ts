...
type GuardedDelayerPrototype = MonacoDelayerInstance & {
  __dobiusDelayerCancellationGuardInstalled?: true
}
...
export function installMonacoDelayerCancellationGuard(): void {
  ...
  if (delayerPrototype.__dobiusDelayerCancellationGuardInstalled) {
    return
  }
  ...
  delayerPrototype.__dobiusDelayerCancellationGuardInstalled = true
}
