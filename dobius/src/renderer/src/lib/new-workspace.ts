...
import type { FolderWorkspaceLinkedTask, DobiusHooks, TaskViewPresetId } from '../../../shared/types'
...
// Why: when a repo has no `dobius.yaml` issueCommand and no per-user override,
...
function getDefaultTabCommandPreview(yamlHooks: DobiusHooks | null): string {
 ...
 * their `dobius.yaml` / `.dobius/issue-command` yet.
 */
