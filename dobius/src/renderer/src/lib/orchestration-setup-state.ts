export const ORCHESTRATION_SETUP_STATE_EVENT = 'dobius:orchestration-setup-state'
export const ORCHESTRATION_ENABLED_STORAGE_KEY = 'dobius.orchestration.enabled'
export const ORCHESTRATION_SETUP_DISMISSED_STORAGE_KEY = 'dobius.orchestration.setupDismissed'
