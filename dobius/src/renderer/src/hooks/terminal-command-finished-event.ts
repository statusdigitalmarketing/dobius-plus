export const DOBIUS_TERMINAL_COMMAND_FINISHED_EVENT = 'dobius:terminal-command-finished'
...
export function dispatchTerminalCommandFinishedEvent(worktreeId: string): void {
  ...
  window.dispatchEvent(
    new CustomEvent<TerminalCommandFinishedEventDetail>(DOBIUS_TERMINAL_COMMAND_FINISHED_EVENT, {
      detail: { worktreeId }
    })
  )
}
