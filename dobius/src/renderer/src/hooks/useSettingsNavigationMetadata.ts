...
import { DobiusLogoSettingsIcon } from '@/components/settings/dobius-logo-settings-icon'
...
import { getAsanaPaneSearchEntries } from '@/components/settings/asana-search'
  ...
  return [
      ...
      : []),
    {
      ...
      description: translate(
        ...
        'Finish the onboarding checklist for core Dobius+ workflows.'
      ),
      icon: DobiusLogoSettingsIcon,
      searchEntries: [
        {
          title: translate(
            'auto.hooks.useSettingsNavigationMetadata.ded9e9032f',
      ...
      ? [
          {
            ...
            icon: Bot,
            searchEntries: getAsanaPaneSearchEntries(),
            group: 'automation'
          }
        ]
      : []),
    ...
    },
    {
      ...
      title: 'Behavior',
      description:
        'Choose how Dobius focuses terminals, opens agents, and keeps the interface simple.',
      icon: SlidersHorizontal,
      searchEntries: [
        {
          title: 'Dobius behavior',
          description:
            'Project folders, terminal focus, Claude resume, sidebar density, and walkthrough.',
          keywords: [
            'behavior',
            'terminal focus',
            'project folder',
