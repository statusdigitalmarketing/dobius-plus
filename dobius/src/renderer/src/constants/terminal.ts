...
export const TOGGLE_TERMINAL_PANE_EXPAND_EVENT = 'dobius-toggle-terminal-pane-expand'
export const FOCUS_TERMINAL_PANE_EVENT = 'dobius-focus-terminal-pane'
export const PASTE_TERMINAL_TEXT_EVENT = 'dobius-paste-terminal-text'
export const SPLIT_TERMINAL_PANE_EVENT = 'dobius-split-terminal-pane'
export const REQUEST_ACTIVE_TERMINAL_PANE_SPLIT_EVENT = 'dobius-request-active-terminal-pane-split'
export const CLOSE_TERMINAL_PANE_EVENT = 'dobius-close-terminal-pane'
export const BACKGROUND_MOUNT_TERMINAL_WORKTREE_EVENT = 'dobius-background-mount-terminal-worktree'
...
export const SYNC_FIT_PANES_EVENT = 'dobius-sync-fit-panes'
