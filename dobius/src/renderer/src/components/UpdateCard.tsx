...
function releaseUrlForVersion(version: string | null): string {
  ...
  return version
    ? `https://github.com/statusdigitalmarketing/dobius-plus/releases/tag/v${version}`
    : 'https://github.com/statusdigitalmarketing/dobius-plus/releases'
}
    ...
    status.state === 'error'
      ? isHttp2UpdateError
        ? {
            ...
            summary: 'Dobius+ can retry through HTTP/1.1 compatibility mode.',
        ...
        : {
            ...
            // failures (commonly GitHub-side) don't read as a bug in Dobius+.
...
function SimpleCardContent({
  ...
  return (
    <div className="flex flex-col gap-2.5 p-3.5">
      ...
      <p className="text-sm text-muted-foreground">
        {translate('auto.components.UpdateCard.05ad78a6d1', 'Dobius+ v{{value0}} is ready.', {
          value0: version
        })}
      </p>
      ...
      <p className="text-sm text-muted-foreground">
        {release
          ...
          : translate(
              ...
              'Dobius+ v{{value0}} is downloading.',
              {
                value0: version
              }
            )}
    ...
    <div className="flex flex-col gap-3 p-4">
      ...
      <p className="text-sm text-muted-foreground">
        {translate(
          ...
          "Dobius+ v{{value0}} is downloaded. Restart when you're ready.",
          { value0: version }
        )}
      </p>
