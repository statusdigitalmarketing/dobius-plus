      ...
      <DialogContent className="gap-4 sm:max-w-[620px]">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            {translate(
              ...
              'Install the Dobius+ CLI and orchestration skill so agents can coordinate through Dobius+.'
            )}
          </DialogDescription>
        </DialogHeader>
        ...
        <AgentSkillSetupPanel
          ...
          description={translate(
            ...
            'Enables agents to hand off context and coordinate work through Dobius+.'
          )}
