...
import { AutomationNotifyField } from './AutomationNotifyField'
...
type AutomationEditorDialogFooterProps = {
  ...
  automationYamlHooksByRepoKey: Record<string, DobiusHooks | null>
...
export function AutomationEditorDialogFooter({
  ...
  return (
    <div className="border-t border-border/50 px-5 py-4">
      ...
      {/* Why: Hermes uses one compact footer row, while Dobius+ adds agent,
      ...
      >
        <div className="min-h-0">
          ...
          <AutomationSetupDecisionField
            createTarget={isHermesTarget ? 'hermes' : 'dobius'}
            draft={draft}
            repos={repos}
