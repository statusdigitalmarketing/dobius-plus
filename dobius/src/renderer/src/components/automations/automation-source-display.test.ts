...
describe('automation source display', () => {
  it('summarizes repo-backed source context separately from run location', () => {
    ...
    expect(getAutomationSourceDisplay(sourceContext)).toEqual({
      label: 'GitHub · devbox · statusdigitalmarketing/dobius-plus',
      title: 'GitHub source · Host: devbox · Account: dev@example.com · Source: statusdigitalmarketing/dobius-plus'
    })
  })
  ...
  it('uses saved remote server labels for runtime-backed sources', () => {
    ...
    expect(
      ...
      label: 'GitHub · dev box · statusdigitalmarketing/dobius-plus',
      title: 'GitHub source · Host: dev box · Source: statusdigitalmarketing/dobius-plus'
    })
  })
