          ...
          <Tooltip>
            ...
            <TooltipContent side="top" sideOffset={6} className="max-w-72">
              {translate(
                ...
                'If Dobius+ or the execution host was unavailable at the scheduled time, Dobius+ runs one missed occurrence when it becomes available within this window. Older missed runs are skipped.'
              )}
            </TooltipContent>
          </Tooltip>
        </span>
