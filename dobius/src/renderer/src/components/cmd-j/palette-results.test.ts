...
const sections: SettingsNavSection[] = [
  {
    ...
    searchEntries: [
      {
        title: 'Dobius CLI',
        description: 'Register or remove the dobius shell command.',
  ...
  {
    id: 'servers',
    title: 'Remote Dobius Servers',
    description: 'Pair remote Dobius runtimes.',
    icon: Settings,
    searchEntries: [{ title: 'Remote Dobius Servers' }],
    group: 'remote'
  },
  {
    id: 'ssh',
...
describe('Cmd+J palette middle-band ranking', () => {
  it.each([
    ...
    ['dobius cli', 'settings:general:cli'],
