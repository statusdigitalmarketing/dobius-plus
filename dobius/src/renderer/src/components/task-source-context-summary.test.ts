...
describe('task source context summary', () => {
  it('shows provider, host, and provider identity for a single repo-backed source', () => {
    ...
    expect(summary.label).toBe('GitHub · devbox · statusdigitalmarketing/dobius-plus')
    expect(summary.title).toBe('GitHub · Host: devbox · Source: statusdigitalmarketing/dobius-plus')
  })
  ...
  it('shows repo-backed provider account labels when accounts can differ by host', () => {
    ...
    expect(summary.title).toBe(
      `GitHub · Host: ${LOCAL_HOST_LABEL}, builder · Account: personal-gh, work-gh · Source: statusdigitalmarketing/dobius-plus · 2 selected projects`
    )
  })
  ...
  it('shows disconnected source-host availability for a single SSH repo source', () => {
    ...
    expect(summary.label).toBe('GitHub · devbox · disconnected · statusdigitalmarketing/dobius-plus')
    expect(summary.title).toBe(
      'GitHub · Host: devbox · Availability: devbox disconnected · Source: statusdigitalmarketing/dobius-plus'
    )
  })
  ...
  it('shows blocked remote-server source-host availability', () => {
    ...
    expect(summary.label).toBe('GitHub · old-server · server update needed · statusdigitalmarketing/dobius-plus')
    expect(summary.title).toBe(
      'GitHub · Host: old-server · Availability: old-server server update needed · Source: statusdigitalmarketing/dobius-plus'
    )
  })
  ...
  it('shows remote-server task-source capability checks', () => {
    ...
    expect(summary.label).toBe('GitHub · old-server · checking server capabilities · statusdigitalmarketing/dobius-plus')
    expect(summary.title).toBe(
      'GitHub · Host: old-server · Availability: old-server checking server capabilities · Source: statusdigitalmarketing/dobius-plus'
    )
  })
  ...
  it('uses saved remote server labels in repo-backed source summaries and notices', () => {
    ...
    expect(
      ...
      label: 'GitHub · dev box · server update needed · statusdigitalmarketing/dobius-plus',
      title:
        'GitHub · Host: dev box · Availability: dev box server update needed · Source: statusdigitalmarketing/dobius-plus'
    })
  ...
  it('shows provider-specific source availability reasons', () => {
    expect(
      ...
      label: 'GitHub · devbox · provider auth needed · statusdigitalmarketing/dobius-plus',
      title:
        'GitHub · Host: devbox · Availability: devbox provider auth needed · Source: statusdigitalmarketing/dobius-plus'
    })
