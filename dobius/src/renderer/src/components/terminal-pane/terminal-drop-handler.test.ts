...
describe('handleTerminalFileDrop', () => {
  ...
  it('uploads client-local drops into the active runtime before pasting paths', async () => {
      ...
      results: [
        {
          ...
          status: 'imported',
          destPath: '/remote/repo/.dobius/drops/logo.png',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(mocks.importExternalPathsToRuntime).toHaveBeenCalledWith(
      ...
      ['/Users/me/logo.png'],
      '/remote/repo/.dobius/drops'
    )
    expect(sendInput).toHaveBeenCalledWith(
      wrapTerminalBracketedPasteText('/remote/repo/.dobius/drops/logo.png')
    )
  ...
  it('uses Windows shell paths for forward-slash UNC runtime worktrees', async () => {
      ...
      results: [
        {
          sourcePath: '/Users/me/logo.png',
          status: 'imported',
          destPath: '//server/share/repo\\.dobius\\drops\\logo.png',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(mocks.importExternalPathsToRuntime).toHaveBeenCalledWith(
      ...
      ['/Users/me/logo.png'],
      '\\\\server\\share\\repo\\.dobius\\drops'
    )
    expect(sendInput).toHaveBeenCalledWith(
      wrapTerminalBracketedPasteText('\\\\server\\share\\repo\\.dobius\\drops\\logo.png')
    )
  })
  ...
  it('uploads to the worktree owner runtime instead of the focused runtime', async () => {
      ...
      results: [
        {
          ...
          status: 'imported',
          destPath: '/remote/repo/.dobius/drops/spec.pdf',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(sendInput).toHaveBeenCalledWith('/remote/repo/.dobius/drops/spec.pdf ')
  })
