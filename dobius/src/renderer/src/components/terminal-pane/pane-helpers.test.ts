...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\dobius\\file.txt', 'windows')).toBe(
      'C:\\Users\\dobius\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\dobius\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\dobius\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\dobius\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\dobius\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.dobius/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.dobius/drops/my file'\\''s $draft.txt'"
    )
  })
})
