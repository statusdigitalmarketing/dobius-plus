...
const HAS_CSS_ANCHOR_POSITIONING =
  ...
  CSS.supports('position-anchor', '--dobius-terminal-overlay-probe') &&
  CSS.supports('top', 'anchor(--dobius-terminal-overlay-probe top)') &&
  CSS.supports('width', 'anchor-size(--dobius-terminal-overlay-probe width)')
