...
// "attach to a still-running TUI" — but Dobius+ restores scrollback against a
...
// font gives Dobius+ a known-good fallback even on clean systems, while the
...
const FALLBACK_FONTS = [
  ...
  'Dobius+ Nerd Font Symbols', // bundled PUA fallback for OMP/Powerline glyphs
