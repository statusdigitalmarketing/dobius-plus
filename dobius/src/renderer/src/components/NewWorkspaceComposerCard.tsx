...
type EphemeralVmRecipeOption = NonNullable<DobiusHooks['environmentRecipes']>[number]
      ...
      <div className="rounded-2xl border border-border/60 bg-muted/40 shadow-inner">
        <div className="flex items-center justify-between gap-3 border-b border-border/60 px-4 py-2.5">
          <div className="font-mono text-[11px] text-muted-foreground">
            {translate('auto.components.NewWorkspaceComposerCard.23bb365554', 'dobius.yaml')}
          </div>
          {headerAction}
        </div>
        {/* Why: long dobius.yaml scripts must not grow the create dialog past the viewport. */}
            ...
            >
              ...
              {setupControlsEnabled && setupConfig ? (
                <div className="space-y-2">
                  ...
                  {/* Why: `dobius.yaml` is the committed source of truth for shared setup,
