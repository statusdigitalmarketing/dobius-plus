  ...
  agent: {
    ...
    get subtitle() {
      return translate(
        ...
        "Dobius+ works with every CLI agent. Choose the one you'll reach for most. Switch any time."
      )
    }
  },
  theme: {
  ...
  notifications: {
    ...
    get subtitle() {
      return translate(
        ...
        'Dobius+ will notify you when agents are done or need help.'
      )
    }
  },
  integrations: {
        ...
        >
          <div className="relative flex h-full min-h-0 flex-col px-6 pb-6 pt-8 sm:px-8 sm:pb-8 sm:pt-9">
            <div className="flex items-center gap-3 text-base font-semibold tracking-tight">
              ...
              />
              <span>
                {translate('auto.components.onboarding.OnboardingFlow.a249f81538', 'Dobius+')}
              </span>
            </div>
