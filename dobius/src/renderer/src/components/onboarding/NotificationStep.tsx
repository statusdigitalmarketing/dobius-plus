            ...
            <div className="min-w-0 space-y-1">
              ...
              <p className="max-w-[58ch] text-[13px] leading-relaxed text-muted-foreground">
                {translate(
                  ...
                  'Open System Settings and make sure Dobius+ is allowed to send notifications.'
                )}
              </p>
            </div>
            <Button
        ...
        <div className="space-y-1">
          ...
          <p className="text-[13px] leading-relaxed text-muted-foreground">
            {translate(
              ...
              'Pick the alert Dobius+ plays after a desktop notification is delivered.'
            )}
          </p>
        </div>
