...
const FEATURE_SETUP_ROWS: readonly FeatureSetupRow[] = [
  {
    ...
    setupSummary: 'Enables browser use, prepares dobius-cli, and leaves cookies for Settings.',
  ...
  },
  {
    ...
    setupSummary: 'Registers the Dobius+ CLI, opens permissions, and prepares the skill.',
  ...
  },
  {
    ...
    setupSummary: 'Registers the Dobius+ CLI, enables orchestration, and prepares the skill.',
