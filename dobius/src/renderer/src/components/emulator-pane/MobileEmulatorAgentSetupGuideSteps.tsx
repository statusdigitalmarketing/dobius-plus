...
export function MobileEmulatorAgentSetupGuideSteps({
  ...
  const terminalWorktreeId = `mobile-emulator-${worktreeId}-dobius-cli-skill-terminal`
        ...
        <div className="min-w-0 flex-1 space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Registers the dobius command for emulator control in agent shells.'
            )}
          </p>
