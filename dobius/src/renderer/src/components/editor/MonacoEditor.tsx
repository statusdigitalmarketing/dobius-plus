  ...
  return (
    ...
    >
      ...
      {selectionAnnotationTarget && shouldShowMarkdownAnnotations && !commentPopover ? (
        <button
          type="button"
          className="dobius-diff-comment-add-btn"
          style={{
            display: 'flex',
      ...
      <Editor
        ...
        options={{
          ...
          // it aligned with Dobius+'s app-level opt-out instead of relying on the
        ...
        // would become a second state owner. Dobius+ restores cursor/scroll from
