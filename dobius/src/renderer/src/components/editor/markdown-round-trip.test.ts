...
describe('rich markdown round trip', () => {
  ...
  it('preserves heading-styled details blocks', () => {
    expect(
      roundTripMarkdown(
        '<details data-dobius-toggle="heading-1"><summary>Toggle</summary><p>Body</p></details>\n'
      )
    ).toBe(
      '<details class="dobius-details" data-dobius-toggle="heading-1">\n<summary>Toggle</summary>\n\nBody\n\n</details>'
    )
  })
  ...
  it('inserts editable text toggles from slash commands', () => {
    expect(slashCommandMarkdown('toggle-text')).toBe(
      '<details class="dobius-details" open>\n<summary></summary>\n\n\n\n</details>'
    )
  ...
  it('inserts editable heading toggles from slash commands', () => {
    expect(slashCommandMarkdown('toggle-h1')).toBe(
      '<details class="dobius-details" data-dobius-toggle="heading-1" open>\n<summary></summary>\n\n\n\n</details>'
    )
