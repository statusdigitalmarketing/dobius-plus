...
export function useEditorPanelExternalContentEvents({
  ...
  useEffect(() => {
    ...
    window.addEventListener(DOBIUS_EDITOR_EXTERNAL_FILE_CHANGE_EVENT, handler as EventListener)
    return () =>
      window.removeEventListener(DOBIUS_EDITOR_EXTERNAL_FILE_CHANGE_EVENT, handler as EventListener)
  ...
  useEffect(() => {
    ...
    window.addEventListener(DOBIUS_EDITOR_FILE_SAVED_EVENT, handler as EventListener)
    return () => window.removeEventListener(DOBIUS_EDITOR_FILE_SAVED_EVENT, handler as EventListener)
