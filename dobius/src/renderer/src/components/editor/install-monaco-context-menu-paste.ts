...
import {
  DOBIUS_CONTEXT_MENU_PASTE_NAME,
  DOBIUS_CONTEXT_MENU_PASTE_PRIORITY,
  runDobiusContextMenuPaste
 ...
 * Dobius+'s trusted IPC bridge instead of the sandbox-blocked navigator.clipboard.
