...
describe('getUntitledFileRoot', () => {
  ...
  it('falls back to the file root for floating markdown files', () => {
    expect(
      getUntitledFileRoot({
        filePath: '/Users/alice/Library/Application Support/Dobius/floating-workspace/untitled.md',
        relativePath: 'untitled.md'
      })
    ).toBe('/Users/alice/Library/Application Support/Dobius/floating-workspace')
  })

  it('handles nested untitled relative paths', () => {
    expect(
      getUntitledFileRoot({
        filePath: '/tmp/dobius/floating-workspace/notes/untitled.md',
        relativePath: 'notes/untitled.md'
      })
    ).toBe('/tmp/dobius/floating-workspace')
  })
})
