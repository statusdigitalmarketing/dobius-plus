...
// Why: this animation tells the full Dobius+ story end-to-end — the user opens a
...
// Dobius+'s dropdown/popover primitives while staying inside the storyboard DOM.
