...
const AGENT_CAPABILITY_SETUP_ROWS: readonly AgentCapabilitySetupRow[] = [
  {
    ...
    get description() {
      return translate(
        ...
        'Let agents coordinate through Dobius+ to keep large, multi-step tasks moving to completion.'
      )
    },
  ...
  },
  {
    ...
    get description() {
      return translate(
        ...
        "Give agents direct access to Dobius+'s browser so they can test pages, capture screenshots, and act on what they see."
      )
    },
