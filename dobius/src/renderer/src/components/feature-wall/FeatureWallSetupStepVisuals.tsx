...
// Mac-style terminal traffic-light dots — the signature of an Dobius+ terminal pane.
...
// Use Dobius+'s browser: a browser pane with a cursor grabbing one highlighted
