...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="dobius-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="dobius-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="dobius-diff-comment-popover-label">
          {title ??
