...
export function useDiffCommentDecorator({
  ...
  useEffect(() => {
    ...
    plus.type = 'button'
    plus.className = 'dobius-diff-comment-add-btn'
      ...
      rangeDecorationIds = editor.deltaDecorations(rangeDecorationIds, [
        {
          ...
          options: {
            isWholeLine: true,
            className: 'dobius-diff-comment-range-highlight'
          }
        }
      ])
    }
  ...
  useEffect(() => {
            ...
            headerActions={
              worktreeId && comment.author === undefined ? (
                <NotesSendMenu
                  ...
                  triggerClassName="dobius-diff-comment-edit"
    ...
    editor.changeViewZones((accessor) => {
      ...
      for (const c of relevant) {
        ...
        dom.className = 'dobius-diff-comment-inline'
