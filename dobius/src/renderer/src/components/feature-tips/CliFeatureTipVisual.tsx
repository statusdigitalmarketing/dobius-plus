...
const CLI_AGENT_COMMANDS = [
  'dobius worktree create --name auth-pr-1',
  'dobius worktree create --name auth-pr-2',
  'dobius orchestration dispatch --task pr1 --to w1',
  'dobius orchestration dispatch --task pr2 --to w2'
]
