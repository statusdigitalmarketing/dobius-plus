...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Dobius Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Dobius Mobile')
  })

  it('labels the restore action explicitly when Dobius Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
