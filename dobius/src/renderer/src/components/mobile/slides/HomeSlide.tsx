      ...
      <div className="mp-app-topbar">
        <div className="mp-app-brand">
          ...
          <span className="mp-app-brand-name">
            {translate('auto.components.mobile.slides.HomeSlide.5d94e8ddcc', 'Dobius+')}
          </span>
        </div>
        <button
          type="button"
      ...
      <div className="mp-scroll-region">
        ...
        <div className="mp-accounts-card">
          <AccountRow
            ...
            email="claude@statusdigitalmarketing.com"
            sessionPct={42}
            weekPct={18}
          />
          <AccountRow
            icon={<OpenAIIcon size={18} />}
            email="codex@statusdigitalmarketing.com"
            sessionPct={67}
            weekPct={31}
          />
        </div>
...
function DobiusLogo(): React.JSX.Element {
  return (
    <svg className="mp-dobius-logo" viewBox="0 0 318.60232 202.66667" fill="currentColor" aria-hidden>
