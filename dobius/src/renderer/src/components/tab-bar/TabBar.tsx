...
import { tearOffTerminalTab } from './terminal-tab-tear-off'
...
function TabBarInner({
  ...
  const isWebClient = (globalThis as { __DOBIUS_WEB_CLIENT__?: boolean }).__DOBIUS_WEB_CLIENT__ === true
  ...
  return (
    <div
      ...
      // Dobius+'s editor. Terminal-pane drops need to keep inserting file paths
              ...
              if (item.type === 'terminal') {
                ...
                return (
                  <SortableTab
                    ...
                    onOpenInNewWindow={() => void tearOffTerminalTab(item.id)}
