...
export const CLOSE_ALL_CONTEXT_MENUS_EVENT = 'dobius-close-all-context-menus'
  ...
  const tabRoot = (
    ...
    >
      ...
      {showActivityAffordance ? (
        ...
        // Dobius+'s filled bell glyph (amber-500 with a subtle drop shadow)
        // so it matches the worktree-level bell in the sidebar — keeping
        // every "needs your attention" surface in Dobius+ consistent.
