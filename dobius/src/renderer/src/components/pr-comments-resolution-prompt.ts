...
export function buildPRCommentsResolutionPrompt({
  ...
  return [
    ...
    '- Host thread resolution is handled by Dobius+ after launch. Do not resolve or unresolve threads on the host, reply on the host, edit host comments, or use provider APIs/CLIs just to change review state.',
