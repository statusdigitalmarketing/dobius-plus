...
export function ResourceUsageStatusSegment({
  ...
  const handleKillSession = useCallback(
    (session: UnifiedSessionRow): void => {
      // Why: orphan sessions have no tab in this Dobius+ instance, so there's
              ...
              <Tooltip delayDuration={200}>
                ...
                <TooltipContent side="top" sideOffset={6} className="z-[70] max-w-xs">
                  {translate(
                    ...
                    "Resident memory held by Dobius+ plus the processes under each worktree's terminals."
                  )}
                </TooltipContent>
              </Tooltip>
              <span className="text-muted-foreground/50">·</span>
              <Tooltip delayDuration={200}>
                ...
                <TooltipContent side="top" sideOffset={6} className="z-[70] max-w-xs">
                  {translate(
                    ...
                    "How much of this machine's physical RAM the Dobius+-tracked processes are sitting on."
                  )}
                </TooltipContent>
              </Tooltip>
            </div>
