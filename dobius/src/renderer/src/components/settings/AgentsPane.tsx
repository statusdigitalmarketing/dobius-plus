    ...
    <section className="space-y-3">
      <SettingsSubsectionHeader
        ...
        description={translate(
          ...
          'Choose whether Dobius+ launches agents with fewer permission prompts or with manual checks.'
        )}
        action={
...
export function AgentsPane({
  ...
  // "installed a new CLI, Dobius+ doesn't see it yet" case without a restart.
