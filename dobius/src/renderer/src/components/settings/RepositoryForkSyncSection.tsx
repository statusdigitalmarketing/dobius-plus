  ...
  return {
    ...
    description:
      ...
      translate(
        ...
        'Dobius+ could not fast-forward this fork safely.'
      )
  }
}
        ...
        <div className="min-w-0 space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'When this fork is behind upstream, Dobius+ can safely fast-forward its default branch. Dobius+ skips the update if the branch has local-only commits or conflicts.'
            )}
          </p>
          <p className="text-xs text-muted-foreground">
            {translate(
