...
export const getGitPaneSearchEntries = createLocalizedCatalog(() => [
  ...
  {
    title: translate('auto.components.settings.git.search.bc7d9f69ce', 'Dobius+ Attribution'),
    description: translate(
    ...
    keywords: [
      ...
      ...translateSearchKeyword('auto.components.settings.git.search.61eab13403', 'dobius')
    ]
  }
])
