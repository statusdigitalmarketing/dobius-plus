...
export function getSystemNotificationSettingsCopy(
  ...
  if (platform === 'darwin') {
    return {
      ...
      failureDescription: 'Enable Allow notifications for Dobius+ in System Settings.'
    }
  }
  ...
  if (platform === 'win32') {
    return {
      ...
      failureDescription: 'Enable notifications for Dobius+ in Windows Settings.'
    }
  }
      ...
      toast.message(
        ...
        ),
        {
          description: translate(
            ...
            'If no macOS banner appeared, enable Allow notifications for Dobius+.'
          ),
          action: {
            label: translate(
      ...
      toast.error(
        ...
        ),
        {
          description: translate(
            ...
            'Check your desktop notification settings for Dobius+.'
          )
        }
      )
    }
