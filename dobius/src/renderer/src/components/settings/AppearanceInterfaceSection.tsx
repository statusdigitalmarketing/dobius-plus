...
export function AppearanceInterfaceSection({
  ...
  return (
    <div className="divide-y divide-border/40">
      ...
      <SearchableSetting
        title="App Skin"
        description="Recolor the entire interface with a legacy Dobius+ palette."
        keywords={['skin', 'theme', 'color', 'palette', 'appearance']}
        forceVisible={forceVisiblePrimary}
      >
        <SettingsRow
          label="App Skin"
                ...
                updateSettings(
                  value === APP_SKIN_NONE
                    ...
                    : // Why: "change everything" — a skin colors the app chrome
                      ...
                      { appSkin: value, terminalThemeDark: value, terminalThemeLight: value }
                )
              }
            >
              <SelectTrigger size="sm" className="min-w-[220px]" aria-label="App Skin">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        <AppearanceAdvancedDisclosure showTopBorder={false}>
          <div className="divide-y divide-border/40">
            ...
            <SearchableSetting
              ...
              keywords={titlebarEntry?.keywords ?? ['titlebar', 'dobius', 'app', 'name']}
            >
              <SettingsSwitchRow
                label={translate(
                  'auto.components.settings.AppearancePane.9868f39007',
            ...
            {isDesktopWindows ? (
              ...
              >
                <SettingsSwitchRow
                  ...
                  // Why: platform constraint + "close keeps Dobius+ running" consequence are
                  // both non-obvious from the label alone.
                  description={translate(
                    'auto.components.settings.AppearancePane.b707773a0d',
                    'When enabled, closing the window keeps Dobius+ running in the system tray instead of quitting.'
                  )}
