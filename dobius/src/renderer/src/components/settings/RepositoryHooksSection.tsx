  ...
  return [
    ...
    },
    {
      ...
      description: translate(
        ...
        'Ignore dobius.yaml; run only your local commands.'
      )
    },
    {
      policy: 'run-both',
      ...
      description: translate(
        ...
        'dobius.yaml first, then your local commands.'
      )
    }
  ]
}
  ...
  return [
    {
      ...
      placeholder: translate(
        ...
        '# e.g. pnpm install cp "$DOBIUS_ROOT_PATH/.env" "$DOBIUS_WORKTREE_PATH/.env"'
      )
    },
    {
      name: 'archive',
      ...
      placeholder: translate(
        ...
        '# e.g. echo "Cleaning up $DOBIUS_WORKSPACE_NAME"'
      )
    }
  ]
}
    ...
    case 'update-available':
      return {
        heading: translate(
          ...
          '`dobius.yaml` could not be parsed'
        ),
        description: translate(
          'auto.components.settings.RepositoryHooksSection.aba825233f',
          'The file contains configuration keys that this version of Dobius+ does not recognize. You may need to update Dobius+, or check the file for typos.'
        )
      }
    case 'invalid':
      return {
        ...
        description: translate(
          ...
          'The core configuration file exists in the repo root, but Dobius+ could not parse the supported hook definitions yet.'
        )
      }
    default:
      return {
        heading: translate(
          ...
          'No `dobius.yaml` detected'
        ),
        description: translate(
          'auto.components.settings.RepositoryHooksSection.b20c5df6ca',
          'Add an `dobius.yaml` file to enable shared setup, archive, or issue-automation defaults for this repo. Example template:'
        )
      }
  }
}
    ...
    <div className="space-y-2">
      <p className="text-[10px] tracking-[0.18em] text-muted-foreground">
        ...
        <code className="rounded bg-muted px-1 py-0.5">
          {translate('auto.components.settings.RepositoryHooksSection.39da2ae12f', 'dobius.yaml')}
        </code>{' '}
          ...
          <p className="text-xs leading-5 text-muted-foreground">
            {isChecking
              ? translate(
                  ...
                  'Local scripts are saved. Dobius+ is still checking dobius.yaml before it can recommend which script source to use.'
                )
              : translate(
                  'auto.components.settings.RepositoryHooksSection.0ce113fd7b',
                  'Local scripts are saved, but Script Source is set to dobius.yaml only.'
                )}
          </p>
        </div>
      </div>
  ...
  const advancedMatchesSearch =
    ...
    matchesSettingsSearch(settingsSearchQuery, {
      ...
      description: translate(
        ...
        'Command source and dobius.yaml details.'
      ),
      keywords: [
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-muted-foreground">
          {translate(
            ...
            'Scripts that run when worktrees are created or archived. Local scripts are stored on this machine; `dobius.yaml` scripts are shared with your team.'
          )}
        </p>
      </div>
                    ...
                    <div className="space-y-2 text-xs text-muted-foreground">
                      <p>
                        {translate(
                          ...
                          'The file is present, but Dobius+ could not find valid `scripts` or `issueCommand` definitions.'
                        )}
                      </p>
...
function renderYamlScriptPreview(hooks: DobiusHooks | null): string {
