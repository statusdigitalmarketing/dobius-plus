...
export function BrowserUseCliStep({
  ...
  return (
    <SearchableSetting
      title={translate('auto.components.settings.BrowserUsePane.c6065d205d', 'Enable Dobius+ CLI')}
      description={translate(
        'auto.components.settings.BrowserUsePane.c79eff0213',
        'Register the Dobius+ CLI so agents can drive the browser.'
      )}
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1 space-y-1">
          <p className="text-sm font-medium">
            {translate('auto.components.settings.BrowserUsePane.c6065d205d', 'Enable Dobius+ CLI')}
          </p>
          <p className="text-xs text-muted-foreground">
            {translate(
              'auto.components.settings.BrowserUsePane.9fca1f7f5d',
              'Registers the Dobius+ CLI command so agents can orchestrate the browser from their shell.'
            )}
          </p>
