...
export function getActiveServerModeDescription(allowLocalRuntime: boolean): string {
  return allowLocalRuntime
    ...
    : translate(
        ...
        'Selecting a saved server makes this browser use that paired Dobius+ runtime as its default Host.'
      )
}
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Pair another Dobius+ runtime, then connect or disconnect it here. Use Advanced > Active Server only when you want to change the default host.'
              )}
            </p>
          </div>
                ...
                <p id="runtime-server-pairing-code-help" className="text-xs text-muted-foreground">
                  ...
                  <span className="font-mono">
                    {translate(
                      ...
                      'dobius serve --pairing-address <host>'
                    )}
                  </span>{' '}
                  {translate(
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Create access links for browsers, mobile clients, or another Dobius+ client to connect back to this running app.'
              )}
            </p>
          </div>
              ...
              <div className="min-w-0 space-y-0.5">
                <div className="text-sm font-medium">
                  {translate(
                    ...
                    'Share this Dobius+ server'
                  )}
                </div>
                <p className="text-xs text-muted-foreground">
                  {translate(
                    'auto.components.settings.RuntimeEnvironmentsPane.84b9b2be05',
                    'Create a revocable access grant so a browser or another Dobius+ client can connect.'
                  )}
                </p>
              </div>
              <Button
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {translate(
                ...
                'Dobius+ will focus this host and load its projects. Existing terminals and browser tabs on other hosts stay alive.'
              )}
            </DialogDescription>
          </DialogHeader>
          {pendingSwitchValue ? (
              ...
              {removingActiveServer
                ? allowLocalRuntime
                  ? translate(
                      ...
                      'Removing the active server first switches Dobius+ back to Local desktop. Existing host sessions are left alone.'
                    )
                  : translate(
                ...
                : translate(
                    ...
                    'This removes the saved server from Dobius+. It does not change the active server.'
                  )}
            </DialogDescription>
          </DialogHeader>
          {pendingRemove ? (
