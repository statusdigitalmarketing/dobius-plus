    ...
    <div className="rounded-lg border border-border/60 p-4">
      ...
      <p className="text-muted-foreground mb-3 text-xs">
        {translate(
          ...
          "While you're using a terminal on your phone, Dobius+ shrinks it to fit your phone screen. When you close the app or switch away, this controls whether it stays at phone size (so interactive CLI tools don't reflow) or resizes back to your desktop. You can always use Restore this terminal or Restore all terminals on the banner to resize manually."
        )}
      </p>
      <Select
