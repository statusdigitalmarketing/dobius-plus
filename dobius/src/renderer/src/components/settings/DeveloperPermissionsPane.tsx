...
export function DeveloperPermissionsPane(): React.JSX.Element {
  ...
  // back to Dobius+, the chip should reflect the new status without a manual
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-sm font-medium">
            ...
            {translate(
              ...
              "Terminal tools inherit Dobius+'s macOS privacy envelope."
            )}
          </div>
          <p className="text-xs text-muted-foreground">
            {translate(
              'auto.components.settings.DeveloperPermissionsPane.6326a4c5cc',
              'Use these controls when a CLI, local app, or automation tool needs macOS privacy access. Dobius+ does not ask at startup.'
            )}
          </p>
        </div>
