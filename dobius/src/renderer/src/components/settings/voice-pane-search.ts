...
export const getVoicePaneSearchEntries = createLocalizedCatalog(() => [
  ...
  {
    title: translate('auto.components.settings.voice.pane.search.conductor', 'Voice Conductor'),
    description: translate(
      'auto.components.settings.voice.pane.search.conductorDesc',
      'Run a background Opus session that routes voice commands and dispatched work.'
    ),
    keywords: [
      ...translateSearchKeyword('auto.components.settings.voice.pane.search.7640ed9848', 'voice'),
      ...translateSearchKeyword('auto.components.settings.voice.pane.search.conductorKw', 'conductor'),
      ...translateSearchKeyword('auto.components.settings.voice.pane.search.routeKw', 'route'),
      ...translateSearchKeyword('auto.components.settings.voice.pane.search.dispatchKw', 'dispatch'),
      ...translateSearchKeyword('auto.components.settings.voice.pane.search.10d45a9fce', 'stt')
    ]
  },
  {
