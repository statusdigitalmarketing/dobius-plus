            ...
            <div className="min-w-0 shrink space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                {translate(
                  ...
                  'Stops idle background agent terminals after the configured idle window and resumes supported sessions when you open them again. Agent sleep preserves launch options for agents started by Dobius+. Manually started agents may resume with your current Dobius+ defaults. Experimental while we tune the safety model.'
                )}
              </p>
            </div>
            <SettingsSwitch
          ...
          {agentHibernationEnabled ? (
            <NumberField
              ...
              description={translate(
                ...
                'How many idle minutes a completed background agent must wait before Dobius+ can sleep it.'
              )}
