  ...
  if (runtimeId) {
    return {
      ...
      description: translate(
        ...
        'Credentials and account checks for this provider are owned by this remote server. Use Settings > Remote Dobius+ Servers > Advanced to edit another default runtime scope.'
      )
    }
  }
  return {
    ...
    description: translate(
      ...
      'Credentials and account checks for this provider are owned by this desktop client. Use Settings > Remote Dobius+ Servers > Advanced to edit server-owned credentials.'
    )
  }
}
...
export function getProviderRateLimitScope(
  ...
  if (runtimeId) {
    return {
      ...
      description: translate(
        ...
        '{{value0}} API budget is fetched from the CLI on this remote server. Use Settings > Remote Dobius+ Servers > Advanced to view another default runtime budget.',
  ...
  return {
    ...
    description: translate(
      ...
      '{{value0}} API budget is fetched from the CLI on this desktop client. Use Settings > Remote Dobius+ Servers > Advanced to view server-owned budgets.',
      { value0: providerLabel }
    )
  }
}
