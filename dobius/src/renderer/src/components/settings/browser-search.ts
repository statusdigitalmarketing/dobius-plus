...
export function getBrowserLinkRoutingDescription(platform: BrowserShortcutPlatform): string {
  return `Open http(s) links in Dobius+'s built-in browser — from the terminal, markdown, and the editor. ${getBrowserLinkRoutingShortcutLabel(platform)} always uses your system browser.`
}
  ...
  return [
    ...
    },
    {
      ...
      description: translate(
        ...
        'Open workspace ports as worktree-specific Dobius+ localhost URLs so browser tabs are easier to tell apart.'
      ),
      keywords: [
        ...translateSearchKeyword('auto.components.settings.browser.search.2d2d995c58', 'browser'),
        ...translateSearchKeyword(
    ...
    },
    {
      ...
      description: translate(
        ...
        'Import cookies from Chrome, Edge, or other browsers to use existing logins inside Dobius+.'
      ),
      keywords: [
        ...translateSearchKeyword('auto.components.settings.browser.search.2d2d995c58', 'browser'),
