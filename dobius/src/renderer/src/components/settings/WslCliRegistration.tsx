...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'dobius'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `dobius` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Dobius+ itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Dobius+ will register {{value0}} so the command works from WSL terminals.',
