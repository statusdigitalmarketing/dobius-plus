...
export const getThemeEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose how Dobius+ looks in the app window.'
    ),
    keywords: [
...
export const getLanguageEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose the language used by the Dobius+ interface.'
    ),
    keywords: [
...
export const getTypographyEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose the font used by the Dobius+ interface.'
    ),
    keywords: [
      ...
      ...translateSearchKeyword('auto.components.settings.appearance.search.1f2880a9d5', 'dobius'),
      ...translateSearchKeyword(
