...
export function BrowserUseSetup({
  ...
  const browserUseInstallCommand = !activeSkillRuntime.installDisabledReason
    ? buildSkillCommandForRuntime(DOBIUS_CLI_SKILL_INSTALL_COMMAND, activeSkillRuntime.agentRuntime)
    : DOBIUS_CLI_SKILL_INSTALL_COMMAND
  const browserUseUpdateCommand = !activeSkillRuntime.installDisabledReason
    ? buildSkillCommandForRuntime(DOBIUS_CLI_SKILL_UPDATE_COMMAND, activeSkillRuntime.agentRuntime)
    : DOBIUS_CLI_SKILL_UPDATE_COMMAND
  ...
  const cliEnabled = isDobiusCliAvailableOnPath(cliStatus)
    ...
    try {
      const next =
        activeSkillRuntime.agentRuntime?.runtime === 'wsl'
          ...
          : await ensureDobiusCliAvailableForAgentSkillTerminal({
      ...
      {showStep2 ? (
        <SearchableSetting
          ...
          description={translate(
            ...
            "Install the Browser Use skill so agents can operate Dobius+'s browser."
          )}
