      ...
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">
          {translate(
            ...
            'Stored locally. Dobius+ sends it only to platform.minimax.io for usage refreshes.'
          )}
        </p>
      </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Optional. Dobius+ can use your normal Claude login; add accounts only if you want quick switching without moving chat sessions.'
            )}
          </p>
        </div>
            ...
            {visibleClaudeAccounts.length === 0 ? (
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                {translate(
                  ...
                  "No managed Claude accounts for {{value0}}. Dobius+ will use that environment's system default Claude login until you add one here.",
                  { value0: accountRuntimeSentenceLabel }
                )}
              </div>
            ) : (
      ...
      <section key="codex-accounts" id="accounts-codex" className="space-y-4 scroll-mt-6">
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Optional. Dobius+ can use your normal Codex login; add accounts only if you want quick switching in Dobius+.'
            )}
          </p>
          <p className="text-xs text-muted-foreground">
            {translate(
              'auto.components.settings.AccountsPane.340d6f7a85',
              'Each account keeps its own local sign-in context in Dobius+. Account auth stays on this device.'
            )}
          </p>
        </div>
        ...
        <SearchableSetting
          ...
          description={translate(
            ...
            'Manage which Codex account Dobius+ uses for live rate limit fetching.'
          )}
            ...
            {visibleCodexAccounts.length === 0 ? (
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                {translate(
                  ...
                  "No managed Codex accounts for {{value0}}. Dobius+ will use that environment's system default Codex login until you add one here.",
                  { value0: accountRuntimeSentenceLabel }
                )}
              </div>
            ) : (
      ...
      <section key="gemini" id="accounts-gemini" className="space-y-4 scroll-mt-6">
        ...
        <SearchableSetting
          ...
          description={translate(
            ...
            'Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google. This uses credentials issued to the Gemini CLI app, not Dobius+. May break if Google updates the CLI. Use at your own risk.'
          )}
          keywords={[
            'gemini',
            'cli',
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google for {{value0}}. This uses credentials issued to the Gemini CLI app, not Dobius+. May break if Google updates the CLI. Use at your own risk.',
                { value0: accountRuntimeSentenceLabel }
              )}
            </p>
          </div>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {translate(
                ...
                'Dobius+ will delete the managed Codex home for this saved account. If it is currently active, Dobius+ falls back to the system default Codex login.'
              )}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {translate(
                ...
                'Dobius+ will delete the managed Claude auth for this saved account. If it is currently active, Dobius+ falls back to the system default Claude login.'
              )}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
