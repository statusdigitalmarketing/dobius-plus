      ...
      {webClientUrl ? (
        ...
        <UnavailableUrlRow
          ...
          description={translate(
            ...
            'Browser link unavailable in this build. The pairing URL still works for Dobius+ clients.'
          )}
        />
      ) : null}
      ...
      {runtimePairingUrl ? (
        <GeneratedUrlRow
          label={translate(
            ...
            'Pair another Dobius+ client'
          )}
          description={translate(
            'auto.components.settings.RuntimePairingUrlGenerator.849825e829',
            'Paste this pairing URL into another Dobius+ client.'
          )}
