...
import type { GlobalSettings, DobiusHooks } from '../../../../shared/types'
...
import { AsanaPane } from './AsanaPane'
...
const SETTINGS_NAV_GROUPS = [
  ...
  {
    id: 'automation',
    titleKey: 'auto.components.settings.Settings.automationTitle',
    titleDefault: 'Automation'
  },
  {
    id: 'interface',
...
function Settings(): React.JSX.Element {
  ...
  const [repoHooksMap, setRepoHooksMap] = useState<
    Record<string, { hasHooks: boolean; hooks: DobiusHooks | null; mayNeedUpdate: boolean }>
  >({})
  ...
  // Why: General owns the Dobius+ CLI controls, including WSL skill-location setup.
  ...
  useEffect(() => {
    ...
    setRepoHooksMap((previous) => {
      ...
      ) as Record<string, { hasHooks: boolean; hooks: DobiusHooks | null; mayNeedUpdate: boolean }>
              ...
              <ActiveSettingsSectionProvider value={activeSectionId}>
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Optional. Dobius+ works with your existing provider logins; add accounts only if you want Dobius+ to help switch between them.'
                  )}
                  badge={translate(
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Coordinate multiple coding agents through Dobius+.'
                  )}
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Finish the core workflows that make Dobius+ useful for parallel agent work.'
                  )}
                ...
                {showDesktopOnlySettings ? (
                  <SettingsSection
                    ...
                    description={translate(
                      ...
                      'Configure mobile emulator support for Dobius+ and coding agents.'
                    )}
                ...
                {showDesktopOnlySettings ? (
                  <SettingsSection
                    ...
                    description={translate(
                      ...
                      'Configure Asana automation inputs for later task and auto-mode phases.'
                    )}
                    searchEntries={getSectionSearchEntries('automation')}
                  >
                    {isSectionMounted('automation') ? <AsanaPane /> : null}
                  </SettingsSection>
                ) : null}
                ...
                <SettingsSection
                  id="behavior"
                  title="Behavior"
                  description="Control how Dobius opens terminals, focuses agents, and keeps the interface simple."
                  searchEntries={getSectionSearchEntries('behavior')}
                >
                  {isSectionMounted('behavior') ? (
                    <BehaviorPane settings={settings} updateSettings={updateSettings} />
                  ) : null}
                </SettingsSection>
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Dobius+ stats plus Claude, Codex, and OpenCode usage analytics.'
                  )}
                  ...
                  description={
                    isWebClient
                      ? translate(
                          ...
                          'Connect this browser to a saved Dobius+ server.'
                        )
                      : translate(
                          'auto.components.settings.Settings.b5ee17826b',
                          'Pair remote Dobius+ runtimes for persistent sessions, richer remote state, and web or mobile handoff.'
                        )
                  }
