...
const EXAMPLE_PROMPTS: string[] = [
  'Using Dobius+ CLI, open https://github.com/notifications and click the first unread pull request.',
  "Take a screenshot of my open Linear board with the Dobius+ CLI and tell me what's blocked.",
  'With Dobius+ CLI, go to our staging app, log in (my cookies are imported), and verify the checkout flow works.'
]
