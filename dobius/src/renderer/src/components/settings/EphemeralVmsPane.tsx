...
const AGENT_PROMPT =
  'Use the dobius-per-workspace-env skill to set up a per-workspace environment for this repo.'
  ...
  return (
    <div className="space-y-6" data-settings-section="ephemeral-vms">
      <AgentSkillSetupPanel
        ...
        onInstall={async () => {
          await window.api.skills.installBundled(EPHEMERAL_VMS_SKILL_NAME)
        }}
        ...
        <ul className="space-y-2">
          <WhatItem
            text={translate(
              ...
              'Writes the recipe & scripts for your provider — connected over an Dobius+ server or SSH.'
            )}
          />
          <WhatItem
            text={translate(
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Recipes your agent adds to dobius.yaml show up here, ready to launch a workspace on.'
              )}
            </p>
          </div>
          <Button
