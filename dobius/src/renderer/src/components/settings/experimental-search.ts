  ...
  (): SettingsSearchEntry[] => [
    ...
    },
    {
      ...
      description: translate(
        ...
        'Stops idle background agent terminals after the configured idle window and resumes supported sessions when opened again. Agent sleep preserves launch options for agents started by Dobius+; manually started agents may resume with current Dobius+ defaults.'
      ),
      keywords: [
        ...translateSearchKeyword(
          'auto.components.settings.experimental.search.0d24759f14',
