          ...
          <DialogDescription className="text-xs">
            {mode === 'yaml'
              ? translate(
                  ...
                  'Import theme YAML files (Warp format) as Dobius+ terminal themes.'
                )
              : translate(
                  'auto.components.settings.WarpThemeImportModal.description',
                  'Import Warp themes as Dobius+ terminal themes.'
                )}
          </DialogDescription>
        </DialogHeader>
              ...
              {!preview.error && mode !== 'yaml' ? (
                <p>
                  {translate(
                    ...
                    "Warp's preloaded themes are part of the Warp app and can't be read from disk. Dobius+ already includes most of them, like Dracula, Gruvbox, Solarized, and Tokyo Night."
                  )}
                </p>
              ) : null}
              {!preview.error && mode !== 'yaml' ? (
