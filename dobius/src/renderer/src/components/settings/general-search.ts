...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'Dobius+ CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the Dobius+ CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the Dobius+ skill so agents know to use the Dobius+ CLI.'
    ),
    keywords: [
...
export const getGeneralUpdateSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Check for app updates and install a newer Dobius+ version.'
    ),
    keywords: [
