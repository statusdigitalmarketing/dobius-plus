...
// task as a work-item source. Leaking the remote name would imply Dobius+
...
export function sameGitHubOwnerRepo(
  ...
  // different casing (e.g. statusdigitalmarketing/dobius-plus vs statusdigitalmarketing/dobius-plus) resolve to the
