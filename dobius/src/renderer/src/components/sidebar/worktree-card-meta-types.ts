...
export type WorktreeCardDetailsHoverProps = WorktreeCardMetaBadgesProps & {
  ...
  onOpenGitHubIssueInDobius?: (event: React.MouseEvent) => void
  onOpenLinearIssueInDobius?: (event: React.MouseEvent) => void
  onOpenReviewInDobius?: (event: React.MouseEvent) => void
  onUnlinkReview?: () => void
