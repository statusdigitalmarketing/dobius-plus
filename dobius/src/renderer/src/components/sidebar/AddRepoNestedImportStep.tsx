        ...
        <div className="min-w-0 shrink-0 space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Choose this if these projects belong together — a monorepo, or just a set of related repos. Dobius+ will group them and let you work from the parent folder.'
            )}
          </p>
        </div>
        <div className="min-w-0 shrink-0 space-y-1">
