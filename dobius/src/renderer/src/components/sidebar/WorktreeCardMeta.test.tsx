...
describe('WorktreeCardDetailsHover', () => {
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        review={{
          ...
          state: 'open',
          url: 'https://github.com/acme/dobius/pull/456',
          status: 'success',
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        issue={{
          ...
          state: 'open',
          url: 'https://github.com/acme/dobius/issues/5518',
          labels: []
        }}
        linearIssue={null}
        review={null}
  ...
  it('puts unlink behind the first PR actions menu and keeps GitHub last', () => {
    ...
    const openInDobiusIndex = markup.indexOf('aria-label="Open in Dobius"')
    ...
    expect(moreActionsIndex).toBeLessThan(openInDobiusIndex)
    expect(openInDobiusIndex).toBeLessThan(viewOnGitHubIndex)
  ...
  it('puts issue copy menu before edit and open actions and keeps GitHub last', () => {
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        onEditIssue={vi.fn()}
        onEditComment={vi.fn()}
        onOpenGitHubIssueInDobius={vi.fn()}
      >
    ...
    expect(editIssueIndex).toBeLessThan(openInDobiusIndex)
    expect(openInDobiusIndex).toBeLessThan(viewOnGitHubIndex)
  })
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        review={{
          ...
          state: 'open',
          url: 'https://gitlab.com/acme/dobius/-/merge_requests/77',
          status: 'success'
        }}
        comment={null}
        onEditIssue={vi.fn()}
  ...
  it('displays Linear issue details with link', () => {
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        onEditIssue={vi.fn()}
        onEditComment={vi.fn()}
        onOpenLinearIssueInDobius={vi.fn()}
      >
        <span>ENG-123</span>
      </WorktreeCardDetailsHover>
    )
