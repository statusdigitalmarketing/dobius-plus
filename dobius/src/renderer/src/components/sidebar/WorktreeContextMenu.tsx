...
const CLOSE_ALL_CONTEXT_MENUS_EVENT = 'dobius-close-all-context-menus'
    ...
    >
      ...
      <DropdownMenu open={menuOpen} onOpenChange={setMenuOpenState} modal={false}>
        ...
        >
          ...
          {/* Why: primary checkout rows remove the project from Dobius+ instead of
