...
vi.mock('@/hooks/useVirtualizedScrollAnchor', () => ({
  VIRTUALIZED_SCROLL_ANCHOR_RECORD_EVENT: 'dobius:test-record-scroll-anchor',
...
vi.mock('./WorktreeCardAgents', () => ({
  ...
  SUPPRESS_WORKTREE_LIST_SCROLL_ADJUSTMENT_EVENT: 'dobius:test-suppress-scroll-adjustment'
}))
...
vi.mock('./WorktreeContextMenu', () => ({
  ...
  CLOSE_ALL_CONTEXT_MENUS_EVENT: 'dobius:test-close-context-menus',
  WORKTREE_CONTEXT_MENU_SCOPE_ATTR: 'data-dobius-context-menu-scope',
...
function makeHostedReview(overrides: Partial<HostedReviewInfo> = {}): HostedReviewInfo {
  return {
    ...
    state: 'open',
    url: 'https://gitlab.com/acme/dobius/-/merge_requests/42',
    status: 'success',
