  ...
  it('rejects issue URLs in the PR input', () => {
    expect(
      buildWorktreeMetaUpdates({
        ...
        issueInput: '',
        prInput: 'https://github.com/statusdigitalmarketing/dobius-plus/issues/6933',
        commentInput: ''
      })
    ).toEqual({
      comment: '',
  ...
  it('accepts PR URLs in the PR input', () => {
    expect(
      buildWorktreeMetaUpdates({
        ...
        currentDisplayName: 'Workspace',
        issueInput: '',
        prInput: 'https://github.com/statusdigitalmarketing/dobius-plus/pull/6934',
        commentInput: ''
      })
    ).toEqual({
      comment: '',
  ...
  it('accepts issue URLs in the issue input', () => {
    expect(
      buildWorktreeMetaUpdates({
        displayNameInput: 'Workspace',
        currentDisplayName: 'Workspace',
        issueInput: 'https://github.com/statusdigitalmarketing/dobius-plus/issues/6933',
        prInput: '',
        commentInput: ''
      })
    ).toEqual({
  ...
  it('rejects PR URLs in the issue input', () => {
    expect(
      buildWorktreeMetaUpdates({
        displayNameInput: 'Workspace',
        currentDisplayName: 'Workspace',
        issueInput: 'https://github.com/statusdigitalmarketing/dobius-plus/pull/6934',
        prInput: '',
        commentInput: ''
      })
    ).toEqual({
