...
const SidebarNav = React.memo(function SidebarNav() {
  ...
  const showActivityButton = useAppStore((s) => shouldShowAgentsButton(s.settings))
  ...
  const activityUnreadCount = useActivityUnreadCount(showActivityButton, 'sidebar-badge')
  ...
  return (
    ...
    >
      ...
      >
        <Bot
          className={cn('size-4 shrink-0', !agentsActive && 'text-worktree-sidebar-foreground/30')}
          strokeWidth={agentsActive ? 2.25 : 1.75}
        />
        <span className="flex-1">
      ...
      >
        <Sparkles
          className={cn('size-4 shrink-0', !skillsActive && 'text-worktree-sidebar-foreground/30')}
          strokeWidth={skillsActive ? 2.25 : 1.75}
        />
        <span className="flex-1">
          {translate('auto.components.sidebar.SidebarNav.skillsNav', 'Skills')}
        </span>
      </button>
      {showActivityButton ? (
        <button
        ...
        >
          ...
          />
          <span className="flex-1">
            {translate('auto.components.sidebar.SidebarNav.activityNav', 'Activity')}
          </span>
        ...
        <ContextMenu>
          <ContextMenuTrigger asChild>
            ...
            >
              ...
              />
              <span className="flex-1">
                {translate('auto.components.sidebar.SidebarNav.1b5c41caee', 'Dobius+ Mobile')}
              </span>
