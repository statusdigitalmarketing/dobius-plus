      ...
      >
        <SelectedTextCopyMenu className="space-y-3">
          ...
          <WorktreeCardIssueDetailSection
            ...
            onOpenGitHubIssueInDobius={
              onOpenGitHubIssueInDobius ? dismissAndRun(onOpenGitHubIssueInDobius) : undefined
            }
          />
          ...
          {linearIssue && (
            <WorktreeCardDetailSection>
              <DetailHeader
                ...
                actions={
                  <>
                    {linearIssue.url && onOpenLinearIssueInDobius && (
                      <MetadataActionIcon
                        label={translate(
                          'auto.components.sidebar.WorktreeCardMeta.2c67730e07',
                          'Open in Dobius+'
                        )}
                        onClick={dismissAndRun(onOpenLinearIssueInDobius)}
                      >
          ...
          <WorktreeCardReviewDetailSection
            ...
            onOpenReviewInDobius={onOpenReviewInDobius}
