            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-[11px] leading-4 text-muted-foreground">
                {translate(
                  ...
                  'Customize what the agent receives before Dobius+ starts it.'
                )}
              </p>
            </div>
            <Button
            ...
            <p className="flex items-start gap-1.5 rounded-md border border-destructive/30 bg-destructive/5 px-2.5 py-2 text-[11px] leading-4 text-destructive">
              ...
              <span>
                {translate(
                  ...
                  "This template does not include {basePrompt}, so the agent will not receive Dobius+'s default prompt."
                )}
              </span>
            </p>
          ) : null}
