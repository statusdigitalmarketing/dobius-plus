...
describe('filterAiVaultSessions', () => {
  ...
  it('matches workspace sessions under prior renamed worktree paths', () => {
    const sessions: AiVaultSession[] = [
      {
        ...baseSession,
        id: 'claude:old-path',
        cwd: '/Users/ada/workspaces/dobius/bream/src'
      },
      {
        ...baseSession,
    ...
    expect(
      filterAiVaultSessions(sessions, {
        ...
        sort: 'updated',
        activeWorktreePaths: [
          '/Users/ada/workspaces/dobius/fix-agent-history',
          '/Users/ada/workspaces/dobius/bream'
        ],
        hideEmptySessions: true
      }).map((session) => session.id)
  ...
  it('filters project scope by the resolved active project key', () => {
    ...
    const sessionProjectById = new Map([
      [projectSession.id, { kind: 'repo' as const, key: 'project:dobius', label: 'Dobius' }],
    ...
    expect(
      filterAiVaultSessions([projectSession, otherSession], {
        ...
        sort: 'updated',
        activeWorktreePaths: [],
        activeProjectKey: 'project:dobius',
        sessionProjectById,
        hideEmptySessions: true
      }).map((session) => session.id)
  ...
  it('matches repo: queries against resolved project labels before folder fallback', () => {
    const sessionProjectById = new Map([
      [baseSession.id, { kind: 'repo' as const, key: 'project:dobius', label: 'Canonical Dobius' }]
    ])
    const projectLabelByKey = new Map([['project:dobius', 'Canonical Dobius']])
...
describe('deriveAiVaultWorkspaceScopePaths', () => {
  it('includes current and same-repo prior filesystem paths', () => {
    expect(
      deriveAiVaultWorkspaceScopePaths({
        id: 'repo1::/Users/ada/workspaces/dobius/fix-agent-history',
        repoId: 'repo1',
        path: '/Users/ada/workspaces/dobius/fix-agent-history',
        priorWorktreeIds: ['repo1::/Users/ada/workspaces/dobius/bream']
      })
    ).toEqual(['/Users/ada/workspaces/dobius/fix-agent-history', '/Users/ada/workspaces/dobius/bream'])
  })

  it('strips folder-workspace instance suffixes from prior ids', () => {
    expect(
      deriveAiVaultWorkspaceScopePaths({
        id: 'repo1::/Users/ada/folders/dobius',
        repoId: 'repo1',
        path: '/Users/ada/folders/dobius',
        priorWorktreeIds: [
          'repo1::/Users/ada/folders/old-dobius::workspace:123e4567-e89b-12d3-a456-426614174000'
        ]
      })
    ).toEqual(['/Users/ada/folders/dobius', '/Users/ada/folders/old-dobius'])
  })
      ...
      deriveAiVaultWorkspaceScopePaths(
        {
          ...
          path: '/Users/ada/workspaces/dobius/fix-agent-history',
          priorWorktreeIds: [
            'repo1::/Users/ada/workspaces/dobius/bream',
            'repo1::/Users/ada/workspaces/dobius/unclaimed-old-path'
          ]
        },
        [
          {
          ...
          {
            id: 'repo1::/Users/ada/workspaces/dobius/bream',
            repoId: 'repo1',
            path: '/Users/ada/workspaces/dobius/bream'
          }
        ]
      )
    ).toEqual([
      '/Users/ada/workspaces/dobius/fix-agent-history',
      '/Users/ada/workspaces/dobius/unclaimed-old-path'
    ])
  })
    ...
    expect(
      deriveAiVaultWorkspaceScopePaths(
        ...
        [
          ...
          {
            id: 'repo2::/Users/ada/workspaces/dobius/bream',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/dobius/bream'
          }
        ]
...
describe('deriveAiVaultScopeSessionPaths', () => {
    ...
    expect(
      deriveAiVaultScopeSessionPaths(
        ...
        [
          ...
          {
            id: 'repo1::/Users/ada/workspaces/dobius/sibling',
            repoId: 'repo1',
            path: '/Users/ada/workspaces/dobius/sibling'
          },
          {
      ...
      '/Users/ada/workspaces/dobius/fix-agent-history',
      '/Users/ada/workspaces/dobius/sibling'
    ])
  })
  ...
  it('adds active project setup paths across repos', () => {
    expect(
      deriveAiVaultScopeSessionPaths(
        {
          id: 'repo1::/Users/ada/workspaces/dobius/app',
          repoId: 'repo1',
          path: '/Users/ada/workspaces/dobius/app',
          priorWorktreeIds: []
        },
        [
          {
          ...
          {
            id: 'repo2::/Users/ada/workspaces/dobius/docs',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/dobius/docs'
          }
        ],
        {
          activeProjectKey: 'project:dobius',
    ...
    ).toEqual(['/Users/ada/workspaces/dobius/app', '/Users/ada/workspaces/dobius/docs'])
  })
  ...
  it('keeps live worktree paths when another setup shares the repo id', () => {
    expect(
      deriveAiVaultScopeSessionPaths(
        ...
        [
          {
            id: 'repo2::/Users/ada/workspaces/dobius/docs-worktree',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/dobius/docs-worktree'
          }
        ],
        {
          activeProjectKey: 'project:dobius',
      ...
      '/Users/ada/workspaces/dobius/app',
      '/Users/ada/workspaces/dobius/docs-worktree',
      '/Users/ada/workspaces/dobius/docs'
    ])
  })
})
  ...
  it('groups sibling worktree sessions by project label when resolved', () => {
    ...
    const sessionProjectById = new Map(
      sessions.map((session) => [
        session.id,
        { kind: 'repo' as const, key: 'project:dobius', label: 'Dobius' }
      ])
    )
    const projectLabelByKey = new Map([['project:dobius', 'Canonical Dobius']])
    ...
    ).toEqual([{ key: 'project:dobius', label: 'Canonical Dobius', sessions }])
  })
...
describe('parseVaultQuery', () => {
  it('keeps quoted terms together', () => {
    expect(parseVaultQuery('"resume picker" repo:dobius path:src')).toEqual({
      terms: ['resume picker'],
      repoTerms: ['dobius'],
      pathTerms: ['src']
    })
