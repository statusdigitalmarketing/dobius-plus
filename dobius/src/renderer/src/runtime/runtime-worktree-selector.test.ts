...
describe('toRuntimeWorktreeSelector', () => {
  it('addresses raw worktree IDs as runtime ID selectors', () => {
    ...
    expect(toRuntimeWorktreeSelector('repo-1::C:/Users/me/dobius/workspaces/dobius/new-worktree')).toBe(
      'id:repo-1::C:/Users/me/dobius/workspaces/dobius/new-worktree'
    )
  })
