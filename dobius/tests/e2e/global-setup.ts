...
export const TEST_REPO_PATH_FILE = path.join(os.tmpdir(), 'dobius-e2e-test-repo-path.txt')
...
export default function globalSetup(): void {
  ...
  if (process.env.DOBIUS_E2E_SSH_LOCALHOST === '1' || process.env.DOBIUS_E2E_SSH_DOCKER === '1') {
    // Why: the SSH specs deploy Dobius's relay from out/relay. The
