...
export const FIXTURE_COMMENTS: PRComment[] = [
  {
    ...
    url: 'https://github.com/acme/dobius/pull/73#discussion_r101',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/dobius/pull/73#issuecomment-102'
  },
  {
    id: 103,
    author: 'carol',
    ...
    url: 'https://github.com/acme/dobius/pull/73#discussion_r103',
...
export async function seedPRCommentsSidebarFixture(page: Page): Promise<PRCommentsSidebarSeed> {
  return page.evaluate(async (fixtureComments: PRComment[]) => {
    ...
    const pr: PRInfo = {
      ...
      state: 'open',
      url: `https://github.com/acme/dobius/pull/${prNumber}`,
    ...
    window.localStorage.setItem('dobius:pr-comment-presentation', 'cards')
