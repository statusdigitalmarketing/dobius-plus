...
test.describe('Tab visibility with closed sidebar', () => {
  ...
  test('first tab stays visible after Cmd+B collapses the sidebar', async ({ dobiusPage }) => {
    ...
    await pressShortcut(dobiusPage, 'b')
  ...
  test('sidebar toggle and Back button stay separated after sidebar collapse', async ({
    ...
    await dobiusPage.addInitScript(() => {
    ...
    await dobiusPage.reload({ waitUntil: 'domcontentloaded' })
