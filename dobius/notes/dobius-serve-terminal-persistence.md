# Dobius Serve Terminal Persistence

## Problem

`dobius serve` exposes terminal tabs to paired web clients through the runtime
...
- Persist `dobius serve` terminal tab, leaf, and PTY/session bindings in the
...
- Do not make browser panes supported in headless `dobius serve`.
