...
**Spec:** [`docs/reference/2026-06-27-dobius-mobile-manual-network-address-design.md`](../2026-06-27-dobius-mobile-manual-network-address-design.md)
            ...
            <AccordionContent className="space-y-3 text-xs text-muted-foreground">
              <p>
                {translate(
                  ...
                  'Dobius Mobile connects directly to this computer. To use it away from the same local network, put your computer and phone on the same private overlay network, then generate the QR code with that network address selected.'
                )}
              </p>
              <ol className="list-decimal space-y-1 pl-4">
                ...
                <li>
                  {translate(
                    ...
                    'Regenerate the QR code and scan it from the Dobius mobile app.'
                  )}
                </li>
              </ol>
            </AccordionContent>
...
- [ ] **Step 2: Manual smoke check**
  ...
  If Dobius can be launched locally with the desktop build:
...
- [ ] **Step 3: Capture before/after screenshots**
  ...
  ```bash
  $HOME/.claude/skills/gstack/browse/dist/browse screenshot /tmp/dobius-mobile-section-before.png --selector ...
  ```
