...
Dobius app shortcuts dispatch by logical key by default.
...
1. Dobius commands that act on terminal UI, such as copy selection, paste, search, clear,
...
This boundary is intentional. It lets non-US layouts use Dobius commands naturally while
