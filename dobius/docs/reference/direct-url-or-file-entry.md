...
1. A URL to open an Dobius browser tab.
...
- Do not open external URLs outside Dobius.
...
- No active worktree: disable the entry, including URL entry, because Dobius browser tabs are worktree-scoped.
