...
export const KO_VALUE_OVERRIDES = {
  ...
  'Add Dobius attribution to commits, PRs, and issues.': '커밋, PR 및 이슈에 Dobius 속성을 추가합니다.',
  ...
  'Dobius uses the GitHub CLI (gh) to show pull requests, issues, and checks.':
    'Dobius는 GitHub CLI(gh)를 사용하여 PR, 이슈 및 검사를 표시합니다.',
  ...
  'CLI skill': 'CLI 스킬',
  'Dobius CLI skill': 'Dobius CLI 스킬',
  ...
  'Review inactive workspaces before deleting their local files and Dobius state.':
    '로컬 파일과 Dobius 상태를 삭제하기 전에 비활성 워크스페이스를 확인하세요.',
  ...
  'Install the Dobius skill so agents know to use the Dobius CLI.':
    '에이전트가 Dobius CLI를 사용하도록 Dobius 스킬을 설치하세요.',
  ...
  "Control Dobius from your phone. Check on agents, review changes, and kick off tasks while you're away from your desk.":
    '휴대폰에서 Dobius를 제어하세요. 자리를 비운 동안 에이전트를 확인하고, 변경 사항을 리뷰하고, 작업을 시작하세요.',
