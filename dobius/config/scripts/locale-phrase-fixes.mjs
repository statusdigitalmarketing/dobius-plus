...
export const LOCALE_PHRASE_FIXES = {
  ...
  zh: [
    ...
    { pattern: /虎鲸:\/\//g, replacement: 'dobius://', whenEnIncludes: 'dobius://' },
    ...
    { pattern: /连接到Dobius/g, replacement: '连接到 Dobius', whenEnIncludes: 'Connect to Dobius' },
    {
      pattern: /开始使用Dobius/g,
      replacement: '开始使用 Dobius',
      whenEnIncludes: 'get started with Dobius'
    },
