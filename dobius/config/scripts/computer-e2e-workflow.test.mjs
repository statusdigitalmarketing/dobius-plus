...
describe('computer-use e2e workflow', () => {
  ...
  it('guards e2e source against fragile fixed waits and stale element indexes', () => {
    ...
    expect(cliDriver).toContain('DOBIUS_DEV_USER_DATA_PATH')
    expect(cliDriver).toContain('dobius-computer-runtime-')
    expect(cliDriver).toContain('retryMissingRuntimeMetadata')
    expect(cliDriver).toContain('Could not read Dobius runtime metadata')
