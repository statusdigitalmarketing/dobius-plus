...
const FPS = Number.parseInt(process.env.DOBIUS_MJPEG_BENCH_FPS ?? '30', 10)
const SECONDS = Number.parseInt(process.env.DOBIUS_MJPEG_BENCH_SECONDS ?? '30', 10)
const FRAME_BYTES = Number.parseInt(process.env.DOBIUS_MJPEG_BENCH_FRAME_BYTES ?? '184320', 10) // ~180 KiB

for (const [name, value] of [
  ['DOBIUS_MJPEG_BENCH_FPS', FPS],
  ['DOBIUS_MJPEG_BENCH_SECONDS', SECONDS],
  ['DOBIUS_MJPEG_BENCH_FRAME_BYTES', FRAME_BYTES]
]) {
