...
const canonicalSkillPath = join(projectDir, 'skills', 'dobius-linear', 'SKILL.md')
...
describe('dobius-linear skill guidance', () => {
  it('keeps canonical and legacy Linear skill bodies from drifting', () => {
    ...
    expect(canonical).toContain('name: dobius-linear')
