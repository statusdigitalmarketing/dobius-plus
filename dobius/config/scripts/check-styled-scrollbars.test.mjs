...
describe('check-styled-scrollbars', () => {
  it('reports renderer vertical scroll containers without an Dobius scrollbar style', () => {
  ...
  it('does not accept nonexistent scrollbar classes as Dobius scrollbar styles', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports inline vertical overflow without an Dobius scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('accepts inline vertical overflow with a stable Dobius scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports logical inline style spreads without an Dobius scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
