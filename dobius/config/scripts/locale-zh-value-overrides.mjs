...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Dobius IDE': 'Dobius IDE',
  'Dobius first': 'Dobius 优先',
  'Dobius Mobile': 'Dobius Mobile',
  'Dobius logo': 'Dobius 标志',
  'Enjoying Dobius?': '喜欢 Dobius 吗？',
  'Get to know Dobius': '了解 Dobius',
  'Expand Dobius': '展开 Dobius',
  'Support Dobius': '支持 Dobius',
  'Restarting Dobius…': '正在重启 Dobius…',
  'Dobius Attribution': 'Dobius 归因',
  'Show Dobius Mobile Button': '显示 Dobius Mobile 按钮',
  ...
  "Give agents direct access to Dobius's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Dobius 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Dobius. It is still on your disk.': '来自 Dobius。它仍保留在您的磁盘上。',
