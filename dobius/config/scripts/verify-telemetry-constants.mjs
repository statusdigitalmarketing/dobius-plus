...
// Asserts that the telemetry compile-time constants — `DOBIUS_BUILD_IDENTITY`
// and `DOBIUS_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Dobius.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Dobius.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `DOBIUS_BUILD_IDENTITY` and `DOBIUS_POSTHOG_WRITE_KEY` with their
