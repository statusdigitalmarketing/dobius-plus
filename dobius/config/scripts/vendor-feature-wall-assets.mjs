...
const DEFAULT_MARKETING_REPO = path.join(
  ...
  'repos',
  'Stably',
  'dobius-marketing-website'
)
const MARKETING_REPO = process.env.DOBIUS_MARKETING_REPO || DEFAULT_MARKETING_REPO
...
const TILES = [
  ...
  {
    id: 'tile-03',
    gifRelativePath: 'public/whats-new/dobius-github.gif',
    posterRelativePath: 'public/whats-new/posters/dobius-github.jpg'
  },
  {
    id: 'tile-04',
  ...
  {
    id: 'tile-05',
    gifRelativePath: 'public/whats-new/dobius-design-mode.gif',
    posterRelativePath: 'public/whats-new/posters/dobius-design-mode.jpg'
  },
  {
    id: 'tile-06',
  ...
  {
    id: 'tile-09',
    gifRelativePath: 'public/whats-new/dobius-cli-demo.gif',
    posterRelativePath: 'public/whats-new/posters/dobius-cli-demo.jpg'
  },
  {
    id: 'tile-10',
  ...
  {
    id: 'tile-12',
    gifRelativePath: 'public/whats-new/dobius-markdown-editor.gif',
    posterRelativePath: 'public/whats-new/posters/dobius-markdown-editor.jpg'
  }
]
