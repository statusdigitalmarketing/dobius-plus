...
const CYCLES = Number.parseInt(process.env.DOBIUS_EPOCH_BENCH_CYCLES ?? '20000', 10)
const PANES_PER_TAB = Number.parseInt(process.env.DOBIUS_EPOCH_BENCH_PANES ?? '2', 10)

for (const [name, value] of [
  ['DOBIUS_EPOCH_BENCH_CYCLES', CYCLES],
  ['DOBIUS_EPOCH_BENCH_PANES', PANES_PER_TAB]
]) {
