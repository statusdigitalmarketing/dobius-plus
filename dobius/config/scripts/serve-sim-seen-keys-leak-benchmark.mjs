...
const CYCLES = Number.parseInt(process.env.DOBIUS_SEEN_KEYS_BENCH_CYCLES ?? '5000', 10)
const HELPERS_PER_WORKTREE = Number.parseInt(process.env.DOBIUS_SEEN_KEYS_BENCH_HELPERS ?? '2', 10)

for (const [name, value] of [
  ['DOBIUS_SEEN_KEYS_BENCH_CYCLES', CYCLES],
  ['DOBIUS_SEEN_KEYS_BENCH_HELPERS', HELPERS_PER_WORKTREE]
]) {
