...
const sections: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Dobius.',
      'Windows: Defender Firewall → Allow app — enable Dobius for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Dobius must be open on your desktop to accept connections.',
      'Try restarting Dobius — the companion server starts on launch.',
