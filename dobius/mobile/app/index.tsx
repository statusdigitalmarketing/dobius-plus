...
export default function HomeScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      void AsyncStorage.getItem('dobius:last-visited-worktree').then((raw) => {
        if (stale || !raw) {
          return
        }
        try {
  ...
  const accountsHosts = useMemo(() => {
    ...
    for (const host of sortedHosts) {
      ...
      // (no Dobius-managed accounts but live rate-limit data for the active
        ...
        >
          <View style={styles.emptyHero}>
            ...
            <Text style={styles.emptyBody}>
              Pair with Dobius on your computer to check on your agents, jump into any terminal, and
