...
export default function RootLayout() {
  ...
  // Why: route `dobius://pair?...` deep links to the confirm screen so
  ...
  useEffect(() => {
    function handleUrl(url: string) {
      ...
      if (code) {
        ...
        // `dobius://pair` route underneath this screen; replacing keeps cancel
      ...
      <View style={styles.root} onLayout={onNavigatorLayout}>
        ...
        >
          <Stack.Screen
            ...
            options={{
              headerShown: false,
              headerTitle: () => <DobiusLogo size={22} />
            }}
          />
