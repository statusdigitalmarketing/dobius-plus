...
export default function PairScanScreen() {
  ...
  const handleBarCodeScanned = useCallback(
    ({ data }: { data: string }) => {
      ...
      if (!offer) {
        setStatus('error')
        setErrorMessage('Not a valid Dobius QR code')
      ...
      <View ref={setPairScanRootRef} style={[styles.container, containerPadding]}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.subtitle}>
            {canAskAgain
              ? 'Scan the QR code from Dobius on your desktop, or paste the pairing code instead.'
        ...
        <TextInputModal
          ...
          placeholder="dobius://pair?code=... or paste the code"
  ...
  return (
    <View ref={setPairScanRootRef} style={[styles.container, containerPadding]}>
      ...
      <View style={styles.steps}>
        <Step number={1} text="Open Dobius on your computer" />
