...
import { DobiusLogo } from '../src/components/DobiusLogo'
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + spacing.sm }]}>
      ...
      <View style={styles.brand}>
        <DobiusLogo size={28} />
        <Text style={styles.brandName}>Dobius</Text>
      ...
      <View style={styles.section}>
        <Pressable
          ...
          onPress={() => void Linking.openURL('https://onDobius.dev')}
        >
          <Globe size={16} color={colors.textSecondary} />
          <Text style={styles.rowValue}>onDobius.dev</Text>
        </Pressable>
        <View style={styles.separator} />
        <Pressable
          style={({ pressed }) => [styles.row, pressed && styles.rowPressed]}
          onPress={() => void Linking.openURL('https://github.com/statusdigitalmarketing/dobius-plus')}
        >
          <GithubIcon />
          <Text style={styles.rowValue}>statusdigitalmarketing/dobius-plus</Text>
        </Pressable>
        <View style={styles.separator} />
        <Pressable
          style={({ pressed }) => [styles.row, pressed && styles.rowPressed]}
          onPress={() => void Linking.openURL('https://x.com/dobius_build')}
        >
          <XIcon />
          <Text style={styles.rowValue}>@dobius_build</Text>
        </Pressable>
      </View>
