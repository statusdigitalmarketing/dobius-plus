...
const PINS_PREFIX = 'dobius:pins:'
const NOTIF_KEY = 'dobius:pushNotificationsEnabled'
...
const TEXT_SCALE_KEY = 'dobius:terminalTextScale'
...
const AUTOCOMPLETE_KEY = 'dobius:terminalAutocompleteEnabled'
...
const TERMINAL_LIVE_INPUT_DISABLED_PREFIX = 'dobius:terminalLiveInputDisabled:'
...
const SIDEBAR_WIDTH_KEY = 'dobius:hostSidebarWidth'
...
const DOCK_WIDTH_KEY = 'dobius:hostDockWidth'
...
export type MobileTerminalLinkOpenMode = 'dobius-browser' | 'phone-browser'

const TERMINAL_LINK_OPEN_MODE_KEY = 'dobius:terminalLinkOpenMode'
export const DEFAULT_TERMINAL_LINK_OPEN_MODE: MobileTerminalLinkOpenMode = 'dobius-browser'
...
export async function loadTerminalLinkOpenMode(): Promise<MobileTerminalLinkOpenMode> {
  try {
    ...
    return raw === 'phone-browser' || raw === 'dobius-browser' ? raw : DEFAULT_TERMINAL_LINK_OPEN_MODE
  } catch {
