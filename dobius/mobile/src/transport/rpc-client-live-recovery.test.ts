...
//   DOBIUS_MOBILE_LIVE_REPRO=1 pnpm vitest run src/transport/rpc-client-live-recovery.test.ts
//   DOBIUS_MOBILE_LIVE_REPRO_FULL=1 ... (adds the 8-minute parked-loop case)
...
const RUN_LIVE =
  process.env.DOBIUS_MOBILE_LIVE_REPRO === '1' || !!process.env.DOBIUS_MOBILE_LIVE_REPRO_FULL
const RUN_FULL = process.env.DOBIUS_MOBILE_LIVE_REPRO_FULL === '1'
...
describe.runIf(!RUN_LIVE)('live foreground recovery (skipped)', () => {
  it('is opt-in via DOBIUS_MOBILE_LIVE_REPRO=1', () => {
