...
const escapedHtmlEntityTokens = [
  { pattern: /&amp;nbsp;/gi, token: '\uE000DOBIUS_MD_ENTITY_NBSP\uE000', value: '&nbsp;' },
  { pattern: /&amp;lt;/gi, token: '\uE000DOBIUS_MD_ENTITY_LT\uE000', value: '&lt;' },
  { pattern: /&amp;gt;/gi, token: '\uE000DOBIUS_MD_ENTITY_GT\uE000', value: '&gt;' },
  { pattern: /&amp;quot;/gi, token: '\uE000DOBIUS_MD_ENTITY_QUOT\uE000', value: '&quot;' },
  { pattern: /&amp;#39;/gi, token: '\uE000DOBIUS_MD_ENTITY_APOS\uE000', value: '&#39;' }
] as const
...
const CODE_PLACEHOLDER_PREFIX_BASE = '\uE000DOBIUS_MD_CODE_'
