...
const REPO_NAMES = ['dobius', 'dashboard', 'mobile', 'runtime', 'docs', 'api', 'desktop', 'site']
const WORKTREE_NAMES = ['manta', 'narwhal', 'otter', 'squid', 'turtle', 'beluga', 'marlin', 'dobius']
...
export function createMockRepos(count: number): MockRepo[] {
  return Array.from({ length: count }, (_, index) => {
    ...
    return {
      id: `repo-${index + 1}`,
      displayName,
      path: `/tmp/dobius-mobile-repro/${displayName}`,
